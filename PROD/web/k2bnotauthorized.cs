...
namespace GeneXus.Programs {
   public class k2bnotauthorized : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         get {
            return "k2bnotauthorized_Execute" ;
         }
      ...
      protected void E11072( )
      {
         /* Start Routine */
         returnInSub = false;
         CallWebObject(formatLink("k2bfsg.k2btoolsaccessdenied.aspx") );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024313815327", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bnotauthorized.js", "?2024313815327", false, true);
         }
