   ...
   public class k2btoolscomponentplaceholder : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB2Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_2Q2( true) ;
         }
         else
         {
            wb_table1_6_2Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_6_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_9_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_6_2Q2e( true) ;
         }
         else
         {
            wb_table1_6_2Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138141566", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("k2btoolscomponentplaceholder.js", "?20243138141566", false, true);
         }
