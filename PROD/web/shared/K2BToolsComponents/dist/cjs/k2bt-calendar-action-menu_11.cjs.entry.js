...
const K2btCalendarActionMenu = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    return ((_b = (_a = this.actions) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0 ? (index.h("div", { class: menuClass, ref: c => (this.quickDaySelectorContainer = c) }, index.h("span", { class: "K2BT_CalendarActionMenu_ToggleButton", onClick: e => {
        e.stopPropagation();
        this.toggleMenu();
      } }), index.h("div", { class: "K2BT_CalendarActionMenuContents" }, this.isOpen && (index.h("ul", { class: "K2BT_CalendarActionMenu_Dropdown" }, this.actions.map(action => (index.h("li", { onClick: e => {
        e.stopPropagation();
        this.executeAction(action);
      } }, index.h("img", { class: 'K2BT_CalendarActionMenu_Image GX_Image_' + action.imageName + '_Class', src: action.imageUrl, alt: utils.LanguageUtils.getTranslatedMessage(action.name) }), index.h("span", null, utils.LanguageUtils.getTranslatedMessage(action.name)))))))))) : ('');
  }
};
...
const K2btCalendarDayInMonthPicker = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
  ...
  render() {
    ...
    return (index.h("div", { class: "K2BT_CalendarPickerContainer" }, index.h("div", { class: "K2BT_CalendarPickerHeader" }, index.h("div", { class: "K2BT_CalendarPickerPreviousMonth", onClick: () => this.previousMonth() }), index.h("div", { class: "K2BT_CalendarPickerCurrentMonth" }, monthName, " ", this.currentYear), index.h("div", { class: "K2BT_CalendarPickerNextMonth", onClick: () => this.nextMonth() })), index.h("div", { class: "K2BT_CalendarPickerWeekdays" }, weeks[0]
      .map(d => d.getDay())
      .map(weekdayNum => (index.h("div", { class: "K2BT_CalendarPickerWeekday" }, DateUtils.getDayOfWeekShortStringFromDayNumber(weekdayNum))))), index.h("div", { class: "K2BT_CalendarPickerCalendar" }, weeks.map(week => (index.h("div", { class: "K2BT_CalendarPickerWeek" }, week.map(date => {
      ...
      return date >= firstDayOfMonth && date <= lastDayOfMonth ? (index.h("div", { class: dayClass, onClick: () => this.dayClickHandler(date) }, date.getDate())) : (index.h("div", { class: "K2BT_CalendarPickerDayPlaceholder" }));
    })))))));
  }
  previousMonth() {
...
const K2btCalendarDayView = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.creatingNewDraft = index.createEvent(this, "creatingNewDraft", 7);
    this.newDraftCreated = index.createEvent(this, "newDraftCreated", 7);
    this.draftCancelled = index.createEvent(this, "draftCancelled", 7);
  ...
  onMouseDown(event) {
    if (this.readonly) {
      ...
      this.draftItem = new utils.CalendarItem();
  ...
  render() {
    ...
    return (index.h("div", { class: dayContainerClasses }, index.h("div", { class: "K2BT_CalendarDayViewHeader" }, index.h("div", { class: "K2BT_CalendarDayViewDoW" }, dayOfWeek), index.h("div", { class: "K2BT_CalendarDayViewDoM" }, dayOfMonth)), index.h("div", { class: "K2BT_AlldayItems" }, allDayItems.map(item => {
      return this.getAllDayItemContents(item);
    }), this.alldayrows
      ? /* Add padding to all day items view */
        Array.from(Array(this.alldayrows - allDayItems.length).keys()).map(i => (index.h("div", { class: "K2BT_AlldayItem", style: { visibility: 'hidden' } }, 'Hidden: ' + i)))
      : ''), index.h("div", { class: "K2BT_CalendarDayContent" }, index.h("div", { class: "K2BT_CalendarDayViewContainerBaseGrid", ref: c => (this.baseGridControl = c), onMouseDown: this.onMouseDown.bind(this), onMouseMove: this.onMouseMove.bind(this), onMouseUp: this.onMouseUp.bind(this) }, hours.map(hour => (index.h("div", { class: "K2BT_CalendarDayHour" }, this.showhours ? index.h("div", { class: "K2BT_CalendarDayHourNumber" }, hour) : '')))), index.h("div", { class: itemsViewClasses }, items.map(item => {
      return this.getInDayItemContents(item, itemRows);
    })), index.h("div", { class: "K2BT_CalendarDayHourMarker", style: hourPositionStyle }))));
  }
  getAllDayItemContents(item) {
    var _a, _b;
    var classList = new Array('K2BT_AlldayItem');
    utils.CalendarItem.addItemClasses(classList, item, this.currentDate);
    var calendar = (_a = this.calendars.filter(c => c.id === item.calendarId)[0]) !== null && _a !== void 0 ? _a : this.calendars[0];
    return (index.h("div", { class: classList.join(' '), onClick: () => this.onItemClicked(item) }, index.h("div", { class: "K2BT_AllDayItemDescription" }, item.description), index.h("k2bt-calendar-action-menu", { actions: item.actions, onActionClicked: e => {
        e.stopPropagation();
        this.onActionClicked(item, e.detail);
      } }), index.h("div", { class: (_b = 'K2BT_CalendarBackground ' + (calendar === null || calendar === void 0 ? void 0 : calendar.class)) !== null && _b !== void 0 ? _b : 'K2BT_Calendar0' })));
  }
  getInDayItemContents(item, itemRows) {
    ...
    return (index.h("div", { class: classList.join(' '), style: style, onClick: () => this.onItemClicked(item), title: item.description + '\n' + periodString }, index.h("div", { class: "K2BT_CalendarDayItemContent" }, index.h("div", { class: "K2BT_CalendarDayItemText" }, index.h("div", { class: "K2BT_CalendarDayItemHeader" }, index.h("div", { class: "K2BT_CalendarDayItemDescription" }, item.description)), index.h("div", { class: "K2BT_CalendarDayItemHourPeriod" }, periodString)), index.h("k2bt-calendar-action-menu", { actions: item.actions, onActionClicked: e => {
        e.stopPropagation();
        this.onActionClicked(item, e.detail);
      } })), index.h("div", { class: (_b = 'K2BT_CalendarBackground ' + (calendar === null || calendar === void 0 ? void 0 : calendar.class)) !== null && _b !== void 0 ? _b : 'K2BT_Calendar0' })));
  }
  getNonAllDayItems() {
    return this.calendars
      .map(c => c.items
      .filter(i => !i.allDay && utils.CalendarItem.isInDay(i, this.getDateFrom(), this.getDateTo()))
      .map(i => {
      i.calendarId = c.id;
      return i;
    }))
  ...
  getAllDayItems() {
    return this.calendars
      .map(c => c.items
      .filter(i => i.allDay && utils.CalendarItem.allDayItemIsInDay(i, this.getDay()))
      .map(i => {
      i.calendarId = c.id;
      return i;
    }))
    ...
    for (const item of items) {
      ...
      for (const row of rows) {
        for (const columnItem of row) {
          if (utils.CalendarItem.calendarItemsCollide(item, columnItem)) {
            overlaps = true;
            break;
          }
        }
...
const K2btCalendarFullView = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.newDraftCreated = index.createEvent(this, "newDraftCreated", 7);
    this.draftCancelled = index.createEvent(this, "draftCancelled", 7);
    this.itemClicked = index.createEvent(this, "itemClicked", 7);
    this.fetchAppointmentsForPeriod = index.createEvent(this, "fetchAppointmentsForPeriod", 7);
  ...
  render() {
    return (index.h("div", { class: "K2BT_CalendarContainer" }, this.getHeader(), index.h("div", { class: "K2BT_CalendarFullViewContent" }, this.getCalendarFullViewContent())));
  }
  getHeader() {
    return this.showheader ? (index.h("div", { class: "K2BT_CalendarFullViewHeader" }, this.getTodayButton(), this.getPreviousNextButtons(), this.getContextTitle(), this.getCalendarSelectionCombobox(), this.getPeriodSelectionCombobox())) : ('');
  }
  componentDidRender() { }
  getCalendarFullViewContent() {
    switch (this.currentview) {
      case CalendarPeriodView.Day:
        return (index.h("k2bt-calendar-day-view", { year: this.dateFrom.getFullYear(), month: this.dateFrom.getMonth(), day: this.dateFrom.getDate(), startHour: this.starthour, endHour: this.endhour, readonly: this.readonly, calendars: this.filterSelectedCalendars(this.calendars), showhours: true, alldayrows: 0, ref: c => (this.dayView = c) }));
      case CalendarPeriodView.Week:
      case CalendarPeriodView.WorkWeek:
        return (index.h("k2bt-calendar-period-view", { dateFrom: this.dateFrom, dateTo: this.dateTo, startHour: this.starthour, endHour: this.endhour, readonly: this.readonly, calendars: this.filterSelectedCalendars(this.calendars), ref: c => (this.weekView = c) }));
      case CalendarPeriodView.Month:
        return (index.h("k2bt-calendar-month-view", { year: this.dateFrom.getFullYear(), month: this.dateFrom.getMonth() + 1, readonly: this.readonly, calendars: this.filterSelectedCalendars(this.calendars), seemorecaption: this.seemorecaption, itemsperday: this.itemsperdayinmonthview, weekstartday: this.weekstartday,
          //@ts-ignore
  ...
  getPeriodSelectionCombobox() {
    if (this.showviewselection) {
      ...
      if (values.length > 1) {
        ...
        return (index.h("div", { class: "K2BT_CalendarPeriodSelectionCombobox" }, index.h("k2bt-enhancedcombo", { onChange: this.periodSelectionChanged.bind(this), includesearch: false, enableadditem: false, includeemptyitem: false, values: values, value: value, ref: c => (this.periodCombo = c) })));
      }
    }
    return '';
  }
  ...
  getContextTitle() {
    return index.h("div", { class: "K2BT_CalendarHeaderTitle" }, DateUtils.getMonthName(this.dateFrom.getMonth()) + ' ' + this.dateFrom.getFullYear());
  }
  periodSelectionChanged() {
    this.switchView(CalendarPeriodView[utils.EnumUtils.getEnumKeyByEnumValue(CalendarPeriodView, this.periodCombo.value[0])]);
  }
  switchView(view) {
  ...
  getPreviousNextButtons() {
    return this.showperiodnavigation ? (index.h("div", { class: "K2BT_CalendarPeriodButtons" }, index.h("div", { class: "K2BT_CalendarPreviousPeriodButton", onClick: this.goToPreviousPeriod.bind(this) }), index.h("div", { class: "K2BT_CalendarNextPeriodButton", onClick: this.goToNextPeriod.bind(this) }))) : ('');
  }
  goToNextPeriod() {
  ...
  getTodayButton() {
    return this.showcalendarnavigation ? (index.h("div", { class: "K2B_CalendarQuickDaySelectorContainer", ref: c => (this.quickDaySelectorContainer = c) }, index.h("div", { class: "K2B_CalendarQuickDaySelector" }, index.h("div", { class: "K2BT_CalendarTodayButton", onClick: this.goToToday.bind(this) }, this.todaycaption), index.h("div", { class: "K2BT_CalendarAdvancedSelectorToggle", onClick: () => (this.advancedSelectorOpen = !this.advancedSelectorOpen) })), this.getAdvancedSelectorContents())) : ('');
  }
  getAdvancedSelectorContents() {
    return this.advancedSelectorOpen ? (index.h("div", { class: "K2BT_CalendarAdvancedSelectorContents" }, index.h("k2bt-calendar-day-in-month-picker", { selectedDate: this.dateFrom, weekstartday: this.weekstartday, onDayClicked: e => {
        this.advancedSelectorOpen = false;
...
const K2btCalendarMonthView = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.dayClicked = index.createEvent(this, "dayClicked", 7);
    this.itemClicked = index.createEvent(this, "itemClicked", 7);
  ...
  render() {
    ...
    return (index.h("div", { class: "K2BT_CalendarMonthView" }, index.h("div", { class: "K2BT_CalendarMonthDayNames" }, weeks[0]
      .map(d => d.getDay())
      .map(d => (index.h("div", { class: "K2BT_CalendarMonthViewDayName" }, DateUtils.getDayOfWeekShortStringFromDayNumber(d))))), weeks.map(w => {
      return (index.h("div", { class: "K2BT_CalendarMonthViewWeek" }, w.map(d => {
        ...
        return (index.h("div", { class: dayClasses, onClick: () => this.onDayClicked(d) }, index.h("div", { class: "K2BT_CalendarMonthDayComponent" }, index.h("div", { class: dayNumberContainerClasses }, d.getDate()), index.h("div", { class: "K2BT_CalendarMonthViewDayAppointmentList" }, visibleAppointments.map(item => {
          var _a;
          var calendar = (_a = this.calendars.filter(c => c.id === item.calendarId)[0]) !== null && _a !== void 0 ? _a : this.calendars[0];
          ...
          return (index.h("div", { class: "K2BT_CalendarMonthViewDayAppointment", onClick: e => {
              e.stopPropagation();
              this.onItemClicked(item);
            }, title: item.description + '\n' + periodString }, index.h("div", { class: classList.join(' ') }), index.h("div", { class: "K2BT_CalendarMonthViewDayAppointmentPeriod" }, periodString), index.h("div", { class: "K2BT_CalendarMonthViewDayAppointmentDescription" }, item.description), index.h("k2bt-calendar-action-menu", { actions: item.actions, onActionClicked: e => this.onActionClicked(item, e.detail) })));
        }), visibleAppointments.length < filteredAppointments.length ? index.h("div", { class: "K2BT_CalendarMonthViewDaySeeMore" }, this.seemorecaption) : ''))));
      })));
    })));
  }
...
const K2btCalendarPeriodView = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.newDraftCreated = index.createEvent(this, "newDraftCreated", 7);
    this.draftCanceled = index.createEvent(this, "draftCanceled", 7);
    this.itemClicked = index.createEvent(this, "itemClicked", 7);
    this.calendars = [];
    this.readonly = true;
    this.draftItemDescription = '(no title)';
...
const K2btEditCollection = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.inputEvent = index.createEvent(this, "input", 7);
    this.changeEvent = index.createEvent(this, "change", 7);
    this.value = [];
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "K2BT_EditCollection", style: !this.enabled ? {} : { display: 'none' } }, !this.enabled
      ? this.value.map(v => (index.h("div", { class: "K2BT_EditCollectionItem" }, index.h("p", { class: "form-control-static" }, index.h("span", { class: this.readonlyclass, "data-gx-readonly": "" }, v)))))
      : ''), index.h("div", { class: "K2BT_EditCollection", style: this.enabled ? {} : { display: 'none' } }, displayedvalues.map((v, index$1) => (index.h("div", { class: "K2BT_EditCollectionItem" }, index.h("input", { class: 'form-control K2BT_EditCollectionItemInput ' + this.inputclass, type: "text", value: v, style: styleObj, maxLength: maxLength, onInput: ev => this.onInput(index$1, ev), ref: c => (this.itemInputs[index$1] = c), onChange: () => this.triggerChangeEvent(), placeholder: this.invitemessage }), index.h("span", { class: "K2BT_EditCollectionItemDelete", onClick: () => this.removeItem(index$1) })))))));
  }
};
K2btEditCollection.DATATYPE_CHARACTER = 'CHAR';
K2btEditCollection.DATATYPE_NUMERIC = 'NUMERIC';
K2btEditCollection.style = k2btEditCollectionCss;
...
const K2btEnhancedcombo = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.selectionErrorEvent = index.createEvent(this, "selectionError", 7);
    this.focusEvent = index.createEvent(this, "focus", 7);
    this.inputEvent = index.createEvent(this, "input", 7);
    this.changeEvent = index.createEvent(this, "change", 7);
    this.searchChangedEvent = index.createEvent(this, "searchChanged", 7);
    this.newRecordClickedEvent = index.createEvent(this, "newRecordClicked", 7);
    this.value = null;
  ...
  processCharacterForCollection(event) {
    ...
    if (key.length == 1) {
      if (document.activeElement != this.searchfield) {
        ...
        var currentValues = utils.ControlInfoValue.getAtomicValues_impl(this.getFilteredValues());
          ...
          if (vals.length > this.headermaxvisibleitems)
            return [
              vals
                ...
                .reduce((prev, curr) => [prev, index.h("span", null, ",\u00A0"), curr]),
              index.h("span", null, "\u00A0(+", vals.length - this.headermaxvisibleitems, ")"),
            ];
          else
            return vals.map(v => this.getSelectedItemSpan(v)).reduce((prev, curr) => [prev, index.h("span", null, ",\u00A0"), curr]);
        }
      }
      else
        return this.emptyitemtext;
  ...
  getSelectedItemSpan(v) {
    return index.h("span", { class: "K2BT_EnhancedControlInfoSelectedValue" }, v.description);
  }
  getReadonlyContent() {
    if (this.value == null)
      return this.emptyitemtext;
  ...
  getHeaderTagsContent(vals) {
    var containsIcons = utils.ControlInfoValue.containsIcons(this.getAtomicValues());
    return vals.map(v => {
      return (index.h("div", { class: "K2BT_EnhancedComboHeaderTag" }, this.showiconsintags && containsIcons && v.imageUrl !== '' ? index.h("img", { class: "K2BT_EnhancedComboTagIcon", src: v.imageUrl }) : '', index.h("span", { class: "K2BT_EnhancedComboHeaderTagDescription" }, v.description), index.h("span", { class: "K2BT_EnhancedComboHeaderTagDelete", onClick: ev => {
  ...
  render() {
    ...
    return (index.h("div", null, index.h("p", { class: "form-control-static", style: this.enabled ? { display: 'none' } : {} }, index.h("span", { class: this.readonlyclass, "data-gx-readonly": "" }, this.getReadonlyContent())), index.h("div", { tabindex: "0", class: "K2BTEnhancedCombo", ref: node => (this.container = node), style: !this.enabled ? { display: 'none' } : {} }, this.addHeaderIfNecessary(), index.h("div", { class: listClass, ref: c => (this.listContainer = c) }, this.includesearch ? (index.h("input", { type: "text", class: "form-control K2BTEnhancedComboSearchInput", ref: c => (this.searchfield = c), onInput: event => {
        this.changeSearchValue(event.target.value);
        event.stopPropagation();
      }, onChange: event => event.stopPropagation(), placeholder: this.searchfieldplaceholder })) : (''), this.getCollectionActionsHeader(), index.h("div", { class: "K2BTEnhancedComboItems" }, this.getComboContent()), this.enableadditem ? (index.h("span", { class: "K2BTEnhancedComboNewAction", onClick: () => this.onIncludeNewRecordClick() }, this.additemcaption)) : ('')))));
  }
  getCollectionActionsHeader() {
    return this.enableselectallaction || this.enableclearselectionaction ? (index.h("div", { class: "K2BT_EnhancedComboCollectionActions" }, this.getClearSelectionAction(), this.getSelectAllAction())) : ('');
  }
  getSelectAllAction() {
    return this.enableselectallaction ? (index.h("span", { class: "K2BT_EnhancedComboSelectAll", onClick: () => this.onSelectAllClick() }, this.selectallcaption)) : ('');
  }
  getClearSelectionAction() {
    return this.enableclearselectionaction ? (index.h("span", { class: "K2BT_EnhancedComboSelectNone", onClick: () => this.onClearSelectionClick() }, this.clearselectioncaption)) : ('');
  }
  ...
  addHeaderIfNecessary() {
    return !this.displayaslist ? (index.h("div", { class: "K2BTEnhancedComboHeader", onClick: () => this.toggleContentVisibilty() }, index.h("div", { class: "K2BTHeaderContent" }, this.getHeaderContent()))) : ('');
  }
  getAtomicValues() {
    return utils.ControlInfoValue.getAtomicValues_impl(this.getRawValues());
  }
  getComboContent() {
    const rawValues = utils.ControlInfoValue.getAtomicValues_impl(this.getRawValues());
    var containsDetails = utils.ControlInfoValue.containsDetails(rawValues);
    var containsIcons = utils.ControlInfoValue.containsIcons(rawValues);
    var containsTrailingText = utils.ControlInfoValue.containsTrailingText(rawValues);
    var containsBadges = utils.ControlInfoValue.containsBadges(rawValues);
    ...
    if (filteredValues.length > 0)
      ...
      return index.h("div", { class: "K2BTEnhancedComboNoItemsFound" }, this.noresultsfoundtext);
  }
  onImageError(e) {
  ...
  getAtomicItemContent(item, containsIcons, containsTrailingText, containsDetails, containsBadges) {
    ...
    return (index.h("div", { class: itemClass, ref: c => {
  ...
  addMainItemContent(item, containsTrailingText, containsDetails) {
    return (index.h("div", { class: "K2BTEnhancedComboItem_TextColumn" }, index.h("div", { class: "K2BTEnhancedComboItem_TextContainer" }, index.h("span", { class: "K2BTEnhancedComboDescription" }, this.getHighlightedText(item.description)), containsTrailingText ? index.h("span", { class: "K2BTEnhancedComboTrailingText" }, this.getHighlightedText(item.trailingText)) : ''), index.h("div", { class: "K2BTEnhancedComboItem_TextContainer" }, containsDetails ? index.h("span", { class: "K2BTEnhancedComboSubtitle" }, this.getHighlightedText(item.detail)) : '')));
  }
  addBadgeIfNecessary(containsBadges, item) {
    ...
    if (!containsBadges)
      ...
      return index.h("div", { class: c });
  }
  addIconIfNecessary(containsIcons, item) {
    if (!containsIcons)
      return '';
    else
      return (index.h("div", { class: "K2BTEnhancedComboIconContainer" }, index.h("img", { class: item.imageUrl === '' ? 'K2BTEnhancedComboIcon K2BTEnhancedComboIconInvisible' : 'K2BTEnhancedComboIcon', src: item.imageUrl, onError: e => this.onImageError(e) })));
  }
  addCheckboxIfNecessary(item) {
    return this.isCollection() ? (index.h("div", { class: "K2BT_EnhancedComboCheckbox" }, index.h("input", { type: "checkbox", checked: this.valueIsSelected(item), tabIndex: -1, disabled: this.selectionIsFull() && !this.valueIsSelected(item) }), index.h("label", { htmlFor: "", "data-gx-sr-only": "" }, "\u00A0"))) : ('');
  }
  getCategoryContent(item, containsDetails, containsIcons, containsTrailingText, containsBadges) {
    return (index.h("div", { class: "K2BTEnhancedComboCategory" }, index.h("span", { class: "K2BTEnhancedComboCategoryName" }, item.description), index.h("div", { class: "K2BTEnchancedComboCategoryContents" }, item.items.map(i => this.getItemContent(i, containsDetails, containsIcons, containsTrailingText, containsBadges)))));
  }
  selectionIsFull() {
  ...
  getHighlightedText(originalText) {
    ...
    if (this.searchvalue == undefined || this.searchvalue == '' || position == -1) {
      return index.h("span", null, originalText);
    }
    else {
      return (index.h("span", null, originalText.substring(0, position), index.h("span", { class: "K2BTEnhancedComboSearchHighlight" }, originalText.substring(position, position + this.searchvalue.length)), this.getHighlightedText(originalText.substring(position + this.searchvalue.length))));
    }
  }
  componentDidRender() {
...
K2btEnhancedcombo.style = k2btEnhancedcomboCss;
...
const K2btMaskedInput = class {
  ...
  render() {
    ...
    return (index.h("div", null, index.h("p", { class: "form-control-static", style: this.enabled ? { display: 'none' } : {} }, index.h("span", { class: readonlyClassString, "data-gx-readonly": "" }, !this.enabled ? this.getInputMask().format(this.value) : '')), index.h("input", { type: "text", inputmode: "text", class: 'form-control ' + classString, value: this.value, ref: el => (this.nativeInput = el), onInput: () => this.onInput(), onChange: () => this.changeEvent.emit(), style: styleObj })));
  }
};
K2btMaskedInput.style = k2btMaskedInputCss;

const k2btNumericInputCss = ":host{display:block}";

const K2btNumericInput = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.inputEvent = index.createEvent(this, "input", 7);
    this.changeEvent = index.createEvent(this, "change", 7);
...
K2btNumericInput.style = k2btNumericInputCss;

const K2btSignaturePad = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.changeEvent = index.createEvent(this, "change", 7);
    this.width = 300;
  ...
  render() {
    ...
    console.log(style);
    return (index.h(index.Host, null, index.h("div", { class: "K2BT_SignaturePadContainer", style: style }, index.h("canvas", { height: this.height, width: this.width, class: "K2BT_SignaturePad", ref: canvas => {
        this.canvas = canvas;
        this.ctx = canvas.getContext('2d');
      } })), this.showclearbutton ? (index.h("button", { class: "K2BT_SignaturePadClearButton", onClick: this.clearCanvas.bind(this) }, this.clearbuttoncaption)) : ('')));
  }
  componentDidRender() {
...
exports.k2bt_calendar_action_menu = K2btCalendarActionMenu;
exports.k2bt_calendar_day_in_month_picker = K2btCalendarDayInMonthPicker;
exports.k2bt_calendar_day_view = K2btCalendarDayView;
exports.k2bt_calendar_full_view = K2btCalendarFullView;
exports.k2bt_calendar_month_view = K2btCalendarMonthView;
exports.k2bt_calendar_period_view = K2btCalendarPeriodView;
exports.k2bt_edit_collection = K2btEditCollection;
exports.k2bt_enhancedcombo = K2btEnhancedcombo;
exports.k2bt_masked_input = K2btMaskedInput;
exports.k2bt_numeric_input = K2btNumericInput;
exports.k2bt_signature_pad = K2btSignaturePad;
