...
import { ImageRegion } from '../../utils/utils';
export class K2btImageRegionSelector {
  constructor() {
  ...
  renderExistingDefinition() {
    ...
    this.elementDivs = [];
    return (h(Host, null,
      h("div", { class: (_c = 'K2BT_LocationInBlueprintSelectorContainer ' + ((_b = (_a = this.imageWithRegionsDefinition) === null || _a === void 0 ? void 0 : _a.Frame) === null || _b === void 0 ? void 0 : _b.class)) !== null && _c !== void 0 ? _c : '', style: {
  ...
  renderRegion(r) {
    ...
    return (h("div", { class: 'K2BT_LocationInBlueprintSelectorItem' +
        ...
        (r.class != '' ? ' ' + r.class : ''), ref: e => this.elementDivs.push({ id: r.id, element: e }), style: style },
      this.getMapForItem(r),
      this.getImage(r, imageUrl),
      h("span", { class: "K2BT_LocationInBlueprintSelectorItemName" }, r.name)));
  }
  ...
  getMapForItem(r) {
    if (r.selectableRegionCoordinates != '') {
      return (h("map", { name: 'K2BT_Image' + r.id },
        h("area", { shape: "poly", coords: r.selectableRegionCoordinates, onClick: () => this.itemClicked(r.id), href: "#", title: this.getTooltipLines(r), ref: c => this.elementsWithTooltips.push(c) }),
        h("area", { shape: "poly", coords: '0,0,' + r.width + ',0,' + r.width + ',' + r.height + ',0,' + r.height, onClick: e => this.clickBelow(e, r.id), onMouseOver: e => this.bringElementBelowToForeground(e, r.id) })));
    }
  }
  ...
  static get is() { return "k2bt-image-region-selector"; }
  static get originalStyleUrls() { return {
    "$": ["k2bt-image-region-selector.css"]
  }; }
  static get styleUrls() { return {
    "$": ["k2bt-image-region-selector.css"]
  }; }
  static get properties() { return {
    "imageWithRegionsDefinition": {
      "type": "unknown",
      "mutable": false,
      "complexType": {
        "original": "ImageWithRegionsDefinition",
        "resolved": "ImageWithRegionsDefinition",
        "references": {
          "ImageWithRegionsDefinition": {
            "location": "import",
            "path": "../../utils/utils"
