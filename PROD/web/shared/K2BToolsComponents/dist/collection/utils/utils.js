...
export class ImageWithRegionsDefinition {
}
export class ImageFrameDefinition {
}
export class ImageRegion {
}
ImageRegion.AVAILABLE = 'AVAILABLE';
ImageRegion.UNAVAILABLE = 'UNAVAILABLE';
export class BaseColorOption {
}
...
export class CalendarItemAction {
}
export class SetPeriodAppointmentsParms {
}
