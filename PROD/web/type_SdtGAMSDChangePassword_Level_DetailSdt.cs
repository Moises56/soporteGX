...
namespace GeneXus.Programs {
   ...
   public class SdtGAMSDChangePassword_Level_DetailSdt : GxUserType
   {
      public SdtGAMSDChangePassword_Level_DetailSdt( )
      {
         ...
         gxTv_SdtGAMSDChangePassword_Level_DetailSdt_Gxdynprop = "";
      }
                                   ...
                                   bool includeNonInitialized )
      {
         ...
         AddObjectProperty("Gxdynprop", gxTv_SdtGAMSDChangePassword_Level_DetailSdt_Gxdynprop, false, false);
         return  ;
      }
      ...
      {
         get {
            return gxTv_SdtGAMSDChangePassword_Level_DetailSdt_Gxdynprop ;
         }

         set {
            sdtIsNull = 0;
            gxTv_SdtGAMSDChangePassword_Level_DetailSdt_Gxdynprop = value;
            SetDirty("Gxdynprop");
         }
      ...
      protected string gxTv_SdtGAMSDChangePassword_Level_DetailSdt_Gxdynprop ;
   ...
   public class SdtGAMSDChangePassword_Level_DetailSdt_RESTInterface : GxGenericCollectionItem<SdtGAMSDChangePassword_Level_DetailSdt>, System.Web.SessionState.IRequiresSessionState
   {
