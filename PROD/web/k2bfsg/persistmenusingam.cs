...
namespace GeneXus.Programs.k2bfsg {
   public class persistmenusingam : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( AV28GXV1 <= AV22PersistedMenuOutputCollection.Count )
         {
            ...
            if ( AV16MenuResult )
            {
               ...
               if ( AV20NewMenu )
               {
                  ...
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menu %1 inserted", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menu %1 updated", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
            ...
            else
            {
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menu %1 could not be inserted", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menu %1 could not be updated", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
         ...
         {
            AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
            AV18Message.gxTpr_Description = StringUtil.Format( "Success. Inserted: %1, Updated: %2", StringUtil.LTrimStr( (decimal)(AV15MenuInserted), 4, 0), StringUtil.LTrimStr( (decimal)(AV17MenuUpdated), 4, 0), "", "", "", "", "", "", "");
            AV19Messages.Add(AV18Message, 0);
         }
         else
         {
