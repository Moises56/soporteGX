...
namespace GeneXus.Programs.k2bfsg {
   public class recoverpasswordstep1 : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAMOUNTOFCHARACTERS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6AmountOfCharacters), 4, 0, ".", "")));
      ...
      protected void WB4C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserbirthday_Internalname, "Birthday", "gx-form-item Attribute_TrnDateLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserfirstname_Internalname, "First name", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttConfirm_Internalname, "", "Confirm", bttConfirm_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\RecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STRUP4C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavUserbirthday_Internalname), 1) == 0 )
            {
            ...
            {
               AV58UserBirthDay = context.localUtil.CToD( cgiGet( edtavUserbirthday_Internalname), 1);
               AssignAttri("", false, "AV58UserBirthDay", context.localUtil.Format(AV58UserBirthDay, "99/99/9999"));
            }
      ...
      protected void S132( )
      {
         ...
         if ( AV9CaptchaIsCorrect )
         {
            ...
            {
               new k2btoolsmsg(context ).execute(  "User name cannot be empty",  2) ;
               AV65ValidFields = false;
            }
            if ( AV27RequireEmail && String.IsNullOrEmpty(StringUtil.RTrim( AV57UserEmail)) )
            {
               new k2btoolsmsg(context ).execute(  "User email cannot be empty",  2) ;
               AV65ValidFields = false;
            }
            if ( AV28RequireFirstName && String.IsNullOrEmpty(StringUtil.RTrim( AV59UserFirstName)) )
            {
               new k2btoolsmsg(context ).execute(  "User first name cannot be empty",  2) ;
               AV65ValidFields = false;
            }
            if ( AV26RequireBirthday && (DateTime.MinValue==AV58UserBirthDay) )
            {
               new k2btoolsmsg(context ).execute(  "User birthday cannot be empty",  2) ;
               AV65ValidFields = false;
            }
            if ( AV65ValidFields )
            {
               ...
               if ( AV16Errors.Count == 0 )
               {
                  ...
                  {
                     AV15ErrorMessage = "Candidate failed identity challenges";
                     AssignAttri("", false, "AV15ErrorMessage", AV15ErrorMessage);
      ...
      protected void S202( )
      {
         ...
         if ( AV16Errors.Count == 0 )
         {
            AV22LastEmailSent = context.localUtil.CToT( AV18GAMUserAttribute.gxTpr_Value, 1);
            AssignAttri("", false, "AV22LastEmailSent", context.localUtil.TToC( AV22LastEmailSent, 8, 5, 1, 2, "/", ":", " "));
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         {
            GX_msglist.addItem("If the information provided in the last step was correct, an email was sent to your account with instructions to recover your password.");
      ...
      protected void S152( )
      {
         ...
         AV69Captchaimage_GXI = GXDbFile.PathToUrl( "data:image/jpeg;charset=utf-8;base64,"+AV7Base64String);
         AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60CaptchaImage)) ? AV69Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV60CaptchaImage))), true);
         AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV60CaptchaImage), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138193832", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/recoverpasswordstep1.js", "?20243138193837", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Responsivetable_mainattributes_attributes_Title = "Recover password";
