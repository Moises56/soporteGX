...
namespace GeneXus.Programs.k2bfsg {
   public class loadapplicationpermissions : GXProcedure
   {
      ...
      void executePrivate( )
      {
            ...
            if ( StringUtil.StrCmp(AV10Activity.gxTpr_Activity.gxTpr_Standardactivitytype, "Maintenance") != 0 )
            {
               ...
               if ( ( AV15Errors.Count == 1 ) && ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(1)).gxTpr_Code == 153 ) )
               {
                  ...
                  if ( AV18isOK )
                  {
                     ...
                     AV16Message.gxTpr_Description = StringUtil.Format( "Permission %1 added successfully", AV17permissionName, "", "", "", "", "", "", "", "");
                  ...
                  else
                  {
                     ...
                     {
                        AV16Message = new GeneXus.Utils.SdtMessages_Message(context);
                        AV16Message.gxTpr_Description = StringUtil.Format( "Error when adding permission %1", AV17permissionName, "", "", "", "", "", "", "", "");
                        AV9Messages.Add(AV16Message, 0);
         ...
         AV16Message = new GeneXus.Utils.SdtMessages_Message(context);
         AV16Message.gxTpr_Description = StringUtil.Format( "Execution finished: %3 permissions already existed. %1 permissions inserted. %2 permissions could not be inserted.", StringUtil.LTrimStr( (decimal)(AV19correctInserts), 4, 0), StringUtil.LTrimStr( (decimal)(AV20failedInserts), 4, 0), StringUtil.LTrimStr( (decimal)(AV21existingPermissions), 4, 0), "", "", "", "", "", "");
         AV9Messages.Add(AV16Message, 0);
