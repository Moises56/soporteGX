...
namespace GeneXus.Programs.k2bfsg {
   public class wwsecuritypolicy : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV16I_LoadCount_Grid = (short)(Math.Round(NumberUtil.Val( GetPar( "I_LoadCount_Grid"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGrid_refresh( AV35GenericFilter_PreviousValue_Grid, AV37Pgmname, AV7CurrentPage_Grid, AV31GenericFilter_Grid, AV14HasNextPage_Grid, AV32GridConfiguration, AV33ClassCollection_Grid, AV26RowsPerPage_Grid, AV16I_LoadCount_Grid, AV34FreezeColumnTitles_Grid) ;
      ...
      protected void WB3E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Security policies", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavGenericfilter_grid_Internalname, StringUtil.RTrim( AV31GenericFilter_Grid), StringUtil.RTrim( context.localUtil.Format( AV31GenericFilter_Grid, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Search...", edtavGenericfilter_grid_Jsonclick, 0, "K2BT_GenericFilter", "", "", "", "", 1, edtavGenericfilter_grid_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_K2BFSG\\WWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, "Grid Settings", "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV27GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", "", true, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttNew_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(83), 2, 0)+","+"null"+");", "Add new", bttNew_Jsonclick, 7, "", "", StyleString, ClassString, bttNew_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e123e1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 83 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_90_3E2( true) ;
         }
         else
         {
            wb_table1_90_3E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_90_3E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e133e1_client"+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e143e1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e153e1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e153e1_client"+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV29Update_Action)) ? AV38Update_action_GXI : context.convertURL( context.PathToRelativeUrl( AV29Update_Action))), !bGXsfl_83_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)) ? AV39Delete_action_GXI : context.convertURL( context.PathToRelativeUrl( AV30Delete_Action))), !bGXsfl_83_Refreshing);
      ...
      {
         /* GeneXus formulas. */
         AV37Pgmname = "K2BFSG.WWSecurityPolicy";
         edtavName_Enabled = 0;
      ...
      protected void STRUP3E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV26RowsPerPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vROWSPERPAGE_GRID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S132( )
      {
         ...
         AV36GXV1 = 1;
         while ( AV36GXV1 <= AV25Messages.Count )
         {
            AV18Message = ((GeneXus.Utils.SdtMessages_Message)AV25Messages.Item(AV36GXV1));
      ...
      protected void E173E2( )
      {
         /* Start Routine */
         returnInSub = false;
         new k2bloadrowsperpage(context ).execute(  AV37Pgmname,  "Grid", out  AV26RowsPerPage_Grid, out  AV28RowsPerPageLoaded_Grid) ;
         ...
         S122 ();
         if (returnInSub) return;
         AV35GenericFilter_PreviousValue_Grid = AV31GenericFilter_Grid;
      ...
      protected void E183E2( )
      {
         ...
         if ( StringUtil.StrCmp(AV35GenericFilter_PreviousValue_Grid, AV31GenericFilter_Grid) != 0 )
         {
            AV35GenericFilter_PreviousValue_Grid = AV31GenericFilter_Grid;
            AssignAttri("", false, "AV35GenericFilter_PreviousValue_Grid", AV35GenericFilter_PreviousValue_Grid);
            GxWebStd.gx_hidden_field( context, "gxhash_vGENERICFILTER_PREVIOUSVALUE_GRID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV35GenericFilter_PreviousValue_Grid, "")), context));
      ...
      private void E193E2( )
      {
         ...
         while ( true )
         {
            ...
            AV38Update_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
            ...
            AV39Delete_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
      ...
      protected void S232( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV37Pgmname,  AV13GridStateKey, out  AV11GridState) ;
         ...
         new k2bsavegridstate(context ).execute(  AV37Pgmname,  AV13GridStateKey,  AV11GridState) ;
      }
      ...
      protected void S122( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV37Pgmname,  AV13GridStateKey, out  AV11GridState) ;
         AV40GXV2 = 1;
         while ( AV40GXV2 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            AV12GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV40GXV2));
      ...
      protected void E163E2( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV37Pgmname,  "Grid", ref  AV32GridConfiguration) ;
         AV32GridConfiguration.gxTpr_Freezecolumntitles = AV34FreezeColumnTitles_Grid;
         new k2bsavegridconfiguration(context ).execute(  AV37Pgmname,  "Grid",  AV32GridConfiguration,  true) ;
         if ( AV26RowsPerPage_Grid != AV27GridSettingsRowsPerPage_Grid )
         {
            AV26RowsPerPage_Grid = AV27GridSettingsRowsPerPage_Grid;
            AssignAttri("", false, "AV26RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV26RowsPerPage_Grid), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV37Pgmname,  "Grid",  AV26RowsPerPage_Grid) ;
            AV7CurrentPage_Grid = 1;
            AssignAttri("", false, "AV7CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV7CurrentPage_Grid), 4, 0));
         }
         gxgrGrid_refresh( AV35GenericFilter_PreviousValue_Grid, AV37Pgmname, AV7CurrentPage_Grid, AV31GenericFilter_Grid, AV14HasNextPage_Grid, AV32GridConfiguration, AV33ClassCollection_Grid, AV26RowsPerPage_Grid, AV16I_LoadCount_Grid, AV34FreezeColumnTitles_Grid) ;
      ...
      protected void wb_table1_90_3E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No results found", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWSecurityPolicy.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_90_3E2e( true) ;
         }
         else
         {
            wb_table1_90_3E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138172321", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/wwsecuritypolicy.js", "?20243138172326", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
         }
      ...
      protected void sendrow_832( )
      {
         ...
         ROClassString = "Attribute_Grid";
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17Id), 12, 0, ".", "")),StringUtil.LTrim( ((edtavId_Enabled!=0) ? context.localUtil.Format( (decimal)(AV17Id), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV17Id), "ZZZZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,85);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(int)edtavId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)83,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMKeyNumLong",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         StyleString = "";
         AV29Update_Action_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV29Update_Action))&&String.IsNullOrEmpty(StringUtil.RTrim( AV38Update_action_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV29Update_Action)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV29Update_Action)) ? AV38Update_action_GXI : context.PathToRelativeUrl( AV29Update_Action));
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdate_action_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"Update",(string)edtavUpdate_action_Tooltiptext,(short)0,(short)1,(short)20,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)7,(string)edtavUpdate_action_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+"e213e2_client"+"'",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV29Update_Action_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
         ...
         StyleString = "";
         AV30Delete_Action_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action))&&String.IsNullOrEmpty(StringUtil.RTrim( AV39Delete_action_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)) ? AV39Delete_action_GXI : context.PathToRelativeUrl( AV30Delete_Action));
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavDelete_action_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"Delete",(string)edtavDelete_action_Tooltiptext,(short)0,(short)1,(short)20,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)7,(string)edtavDelete_action_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+"e223e2_client"+"'",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV30Delete_Action_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'PAGINGNEXT(GRID)'","{handler:'E153E1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV35GenericFilter_PreviousValue_Grid',fld:'vGENERICFILTER_PREVIOUSVALUE_GRID',pic:'',hsh:true},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV14HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV32GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV33ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV16I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV34FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'E_UPDATE'","{handler:'E213E2',iparms:[{av:'AV17Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("'E_UPDATE'",",oparms:[{av:'AV17Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("'E_DELETE'","{handler:'E223E2',iparms:[{av:'AV17Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("'E_DELETE'",",oparms:[{av:'AV17Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E193E2',iparms:[{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV16I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV14HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("'PAGINGFIRST(GRID)'","{handler:'E143E1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV35GenericFilter_PreviousValue_Grid',fld:'vGENERICFILTER_PREVIOUSVALUE_GRID',pic:'',hsh:true},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV14HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV32GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV33ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV16I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV34FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'","{handler:'E113E1',iparms:[{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'","{handler:'E163E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV35GenericFilter_PreviousValue_Grid',fld:'vGENERICFILTER_PREVIOUSVALUE_GRID',pic:'',hsh:true},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV14HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV32GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV33ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV16I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV34FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''},{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV27GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'}]");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'",",oparms:[{av:'AV32GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV35GenericFilter_PreviousValue_Grid',fld:'vGENERICFILTER_PREVIOUSVALUE_GRID',pic:'',hsh:true},{av:'AV33ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{ctrl:'NEW',prop:'Visible'},{av:'AV34FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E203E2',iparms:[{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV14HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV32GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV33ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV19Name = "";
         AV29Update_Action = "";
         AV38Update_action_GXI = "";
         AV30Delete_Action = "";
         AV39Delete_action_GXI = "";
      ...
      private string AV38Update_action_GXI ;
      private string AV39Delete_action_GXI ;
