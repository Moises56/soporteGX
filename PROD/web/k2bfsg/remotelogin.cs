   ...
   public class remotelogin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB4N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentrepository_Internalname, "Text Block", "", "", lblCurrentrepository_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RemoteLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbexternalauthentication_Internalname, "Login using", "", "", lblTbexternalauthentication_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RemoteLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /*  Grid Control  */
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV65UserName, StringUtil.RTrim( context.localUtil.Format( AV65UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Username or email", edtavUsername_Jsonclick, 0, "K2BT_LoginUsername", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "start", true, "", "HLP_K2BFSG\\RemoteLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblForgotpassword_action_Internalname, "Forgot password", "", "", lblForgotpassword_action_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114n1_client"+"'", "", "K2BT_LoginSecondaryAction", 7, "", lblForgotpassword_action_Visible, 1, 0, 0, "HLP_K2BFSG\\RemoteLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCreateanaccount_action_Internalname, "Create account", "", "", lblCreateanaccount_action_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124n1_client"+"'", "", "K2BT_LoginSecondaryAction", 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\RemoteLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Div Control */
            ...
            ClassString = "CheckBoxAttribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavRememberme_Internalname, StringUtil.BoolToStr( AV55RememberMe), "", "Remember me", chkavRememberme.Visible, chkavRememberme.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(59, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,59);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void E164N2( )
      {
         ...
         S122 ();
         if (returnInSub) return;
         AV34ForgotPassword_Action = "Forgot password";
         AV28CreateAnAccount_Action = "Create account";
      ...
      protected void S192( )
      {
         ...
         if ( StringUtil.StrCmp(AV23CaptchaRequiredText, "true") == 0 )
         {
            ...
            AV81Captchaimage_GXI = GXDbFile.PathToUrl( "data:image/jpeg;charset=utf-8;base64,"+AV18Base64String);
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20CaptchaImage)) ? AV81Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV20CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV20CaptchaImage), true);
         }
         else
         {
            ...
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20CaptchaImage)) ? AV81Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV20CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV20CaptchaImage), true);
            AV81Captchaimage_GXI = GXDbFile.PathToUrl( "data:image/jpeg;charset=utf-8;base64,R0lGODlhAQABAPAAAP///////ywAAAAAAQABAEAIBAABBAQAOw==");
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20CaptchaImage)) ? AV81Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV20CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV20CaptchaImage), true);
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138223354", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/remotelogin.js", "?20243138223357", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
