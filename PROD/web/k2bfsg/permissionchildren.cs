...
namespace GeneXus.Programs.k2bfsg {
   public class permissionchildren : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_52", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_52), 8, 0, ".", "")));
      ...
      protected void WB4G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAdd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(52), 2, 0)+","+"null"+");", "Add new", bttAdd_Jsonclick, 5, bttAdd_Tooltiptext, "", StyleString, ClassString, bttAdd_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'E_ADD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\PermissionChildren.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STRUP4G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV32ApplicationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV32ApplicationId"), ".", ","), 18, MidpointRounding.ToEven));
            wcpOAV28PermissionId = cgiGet( sPrefix+"wcpOAV28PermissionId");
            AV32ApplicationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vAPPLICATIONID"), ".", ","), 18, MidpointRounding.ToEven));
            AV15CurrentPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vCURRENTPAGE_GRID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void wb_table1_60_4G2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No children found", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\PermissionChildren.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV32ApplicationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV32ApplicationId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV32ApplicationId", StringUtil.LTrimStr( (decimal)(AV32ApplicationId), 12, 0));
         }
         else
         {
            AV32ApplicationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV32ApplicationId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138141811", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2bfsg/permissionchildren.js", "?20243138141813", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Gridcomponent_grid_Title = "Permission children";
