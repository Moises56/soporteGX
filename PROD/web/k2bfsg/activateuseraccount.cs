...
namespace GeneXus.Programs.k2bfsg {
   public class activateuseraccount : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public activateuseraccount( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2bfsg.activateuseraccount.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV19ActivationKey))}, new string[] {"ActivationKey"}) +"\">") ;
      ...
      {
         return "K2BFSG.ActivateUserAccount" ;
      }
      ...
      protected void WB4K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbmsg_Internalname, lblTbmsg_Caption, "", "", lblTbmsg_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\ActivateUserAccount.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGotologin_Internalname, "", "Go to login", bttGotologin_Jsonclick, 7, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e114k1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\ActivateUserAccount.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E124K2( )
      {
         ...
         {
            AV27ActivityLogProperty = ((SdtK2BAttributeValue_Item)AV28GXV1.Item(AV29GXV2));
            this.executeExternalObjectMethod("", false, "gx.core.ds", "setOption", new Object[] {AV27ActivityLogProperty.gxTpr_Attributename,AV27ActivityLogProperty.gxTpr_Attributevalue}, false);
      ...
      protected void S142( )
      {
         ...
         if ( AV20isOK )
         {
            lblTbmsg_Caption = "Your user user was activated successfully!"+StringUtil.NewLine( )+"You must go to the Login page to enter the application.";
            AssignProp("", false, lblTbmsg_Internalname, "Caption", lblTbmsg_Caption, true);
         }
         else
         {
            AV30GXV3 = 1;
            while ( AV30GXV3 <= AV8Errors.Count )
            {
               AV7Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV8Errors.Item(AV30GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024313820997", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/activateuseraccount.js", "?2024313820100", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttGotologin_Internalname = "GOTOLOGIN";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E134K2',iparms:[]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("'E_GOTOLOGIN'","{handler:'E114K1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV27ActivityLogProperty = new SdtK2BAttributeValue_Item(context);
      ...
      private string bttGotologin_Internalname ;
      private string bttGotologin_Jsonclick ;
      ...
      private SdtK2BAttributeValue_Item AV27ActivityLogProperty ;
   }
