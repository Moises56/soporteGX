...
namespace GeneXus.Programs.k2bfsg {
   public class k2btoolsaccessdenied : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Access denied") ;
      ...
      protected void WB3M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "You don't have permissions to access this feature", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BTools_NotAuthorizedTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\K2BToolsAccessDenied.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDescription_Internalname, "To solve this, contact the system administrator", "", "", lblDescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BTools_NotAuthorizedDescription", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\K2BToolsAccessDenied.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavLogin_againaction_Internalname, "Login_Again Action", "gx-form-item TextBlock_FloatRightLabel", 0, true, "width: 25%;");
            /* Single line edit */
      ...
      protected void START3M2( )
      {
         ...
         Form.Meta.addItem("description", "Access denied", 0) ;
         context.wjLoc = "";
      ...
      protected void E113M2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV5Login_AgainAction = "Login as a different user";
         AssignAttri("", false, "AV5Login_AgainAction", AV5Login_AgainAction);
         AV8GXV2 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138174935", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/k2btoolsaccessdenied.js", "?20243138174935", false, true);
