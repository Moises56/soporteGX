...
namespace GeneXus.Programs.k2bfsg {
   public class testauthenticationtype : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return "Test Authentication Type" ;
      }
      ...
      protected void WB3U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, "Password", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttTest_Internalname, "", "Confirm", bttTest_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\TestAuthenticationType.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3U2( )
      {
         ...
         Form.Meta.addItem("description", "Test Authentication Type", 0) ;
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         /* 'U_OPENPAGE' Routine */
         returnInSub = false;
         lblTitle_Caption = StringUtil.Format( "Testing authentication type: %1", AV13Name, "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138182125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/testauthenticationtype.js", "?20243138182128", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblTitle_Caption = "Testing authentication type: %1";
         ...
         Attributes_Title = "Test authentication type";
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Test Authentication Type";
