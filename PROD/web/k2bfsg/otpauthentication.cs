...
namespace GeneXus.Programs.k2bfsg {
   public class otpauthentication : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Login - OTP validation") ;
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, "Code", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttValidatecode_Internalname, "", "Validate code", bttValidatecode_Jsonclick, 5, "", "", StyleString, ClassString, bttValidatecode_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_VALIDATECODE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\OTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "K2BToolsTableCell_ActionContainer", "start", "top", "", "flex-grow:1;", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBacktologin_Internalname, "", "Back to login", bttBacktologin_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_BACKTOLOGIN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\OTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START4B2( )
      {
         ...
         Form.Meta.addItem("description", "Login - OTP validation", 0) ;
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138193390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/otpauthentication.js", "?20243138193395", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblErrors_Caption = "To enter app, the second authentication factor must be validated.";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
