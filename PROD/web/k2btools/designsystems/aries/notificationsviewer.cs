   ...
   public class notificationsviewer : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_action_Internalname, "View all", "", "", lblViewall_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e110q1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools\\DesignSystems\\Aries\\NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEnablenotifications_action_Internalname, "Enable desktop notifications", "", "", lblEnablenotifications_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e120q1_client"+"'", "", "K2BT_TextAction", 7, "", lblEnablenotifications_action_Visible, 1, 0, 0, "HLP_K2BTools\\DesignSystems\\Aries\\NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRefresh_action_Internalname, "Refresh", "", "", lblRefresh_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e130q1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools\\DesignSystems\\Aries\\NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
         ...
         if ( wbEnd == 21 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_notificationsgrid_Internalname, "No notifications", "", "", lblI_noresultsfoundtextblock_notificationsgrid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BTools\\DesignSystems\\Aries\\NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138142934", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/notificationsviewer.js", "?20243138142934", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BTools.DesignSystems.Aries.NotificationsButtonRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
