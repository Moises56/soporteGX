   ...
   public class gamexamplerecoverpasswordstep2 : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB310( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, "User Name", "col-xs-12 AttributeLabel", 1, true, "");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024313816120", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplerecoverpasswordstep2.js", "?2024313816123", false, true);
