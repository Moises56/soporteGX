   ...
   public class k2blogout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB2P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_2P2( true) ;
         }
         else
         {
            wb_table1_6_2P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_2P2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_6_2P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_9_2P2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_6_2P2e( true) ;
         }
         else
         {
            wb_table1_6_2P2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_2P2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_12_2P2( true) ;
         }
         else
         {
            wb_table3_12_2P2( false) ;
         }
         return  ;
      }

      protected void wb_table3_12_2P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_12_2P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_19_2P2( true) ;
         }
         else
         {
            wb_table4_19_2P2( false) ;
         }
         return  ;
      }

      protected void wb_table4_19_2P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_12_2P2e( true) ;
         }
         else
         {
            wb_table3_12_2P2e( false) ;
         }
      }

      protected void wb_table4_19_2P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_19_2P2e( true) ;
         }
         else
         {
            wb_table4_19_2P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138153929", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2blogout.js", "?20243138153929", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E122P2',iparms:[]");
         setEventMetadata("'CONFIRMYES'",",oparms:[]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E132P2',iparms:[]");
