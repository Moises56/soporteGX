      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "soporte",  "soporte",  "List",  "",  AV22Pgmname) )
            {
               ...
               getPrinter().GxDrawText("You are not authorized to view this report", 63, Gx_line+0, 764, Gx_line+32, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("soportes", 325, Gx_line+0, 501, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
               {
                  ...
                  getPrinter().GxDrawText("Search", 10, Gx_line+7, 55, Gx_line+22, 0+256, 0, 0, 0) ;
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15hostName_Filter)) )
               {
                  H3B0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText("Name", 10, Gx_line+7, 40, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               ...
               getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("ID", 18, Gx_line+7, 85, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("HostName", 93, Gx_line+7, 182, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Serie", 190, Gx_line+7, 279, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("IPV4", 287, Gx_line+7, 376, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("MAC", 384, Gx_line+7, 483, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Modelo", 491, Gx_line+7, 590, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("NombreUsuario", 598, Gx_line+7, 697, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Departamento", 705, Gx_line+7, 804, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
