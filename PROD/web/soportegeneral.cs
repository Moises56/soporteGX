...
namespace GeneXus.Programs {
   public class soportegeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6soporteID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6soporteID), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"SOPORTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4soporteID), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSOPORTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6soporteID), 9, 0, ".", "")));
      ...
      protected void STRUP2T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6soporteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6soporteID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6soporteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6soporteID), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6soporteID", StringUtil.LTrimStr( (decimal)(AV6soporteID), 9, 0));
         }
         else
         {
            AV6soporteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6soporteID_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6soporteID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6soporteID), 9, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243138143093", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("soportegeneral.js", "?20243138143093", false, true);
