...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void Createsoporte( )
      {
         string cmdBuffer = "";
         /* Indices for table soporte */
         try
         {
            cmdBuffer=" CREATE TABLE [soporte] ([soporteID] int NOT NULL IDENTITY(1,1), [hostName] nvarchar(40) NOT NULL , [serie] nvarchar(40) NOT NULL , [ipv4] nvarchar(40) NOT NULL , [mac] nvarchar(40) NOT NULL , [modelo] nvarchar(40) NOT NULL , [nombreUsuario] nvarchar(40) NOT NULL , [nombreDepartamento] nvarchar(40) NOT NULL , PRIMARY KEY([soporteID]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[soporte]") ;
               cmdBuffer=" DROP TABLE [soporte] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[soporte]") ;
                     cmdBuffer=" DROP FUNCTION [soporte] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      {
         string cmdBuffer = "";
         /* Indices for table products */
         try
         {
            cmdBuffer=" CREATE TABLE [products] ([productsId] smallint NOT NULL , [productsNombre] nvarchar(40) NOT NULL , [productsPrecio] smallint NOT NULL , PRIMARY KEY([productsId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[products]") ;
               cmdBuffer=" DROP TABLE [products] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[products]") ;
                     cmdBuffer=" DROP FUNCTION [products] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                     RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
                     RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("soporte",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"soporte"}) ) ;
            return false ;
         }
         if ( tableexist("products",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"products"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "Createsoporte" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "Createproducts" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"soporte", ""}) );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"products", ""}) );
      }
