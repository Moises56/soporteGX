...
namespace GeneXus.Programs.k2bfsg {
   public class roleaddpermission : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV39RoleId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vROLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV39RoleId), "ZZZZZZZZZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vAPPLICATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ApplicationId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vI_LOADCOUNT_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25I_LoadCount_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_124", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_124), 8, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13CurrentPage_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vGENERICFILTER_PREVIOUSVALUE_AVAILABLEPERMISSIONS", StringUtil.RTrim( AV72GenericFilter_PreviousValue_AvailablePermissions));
         GxWebStd.gx_hidden_field( context, "gxhash_vGENERICFILTER_PREVIOUSVALUE_AVAILABLEPERMISSIONS", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV72GenericFilter_PreviousValue_AvailablePermissions, "")), context));
         GxWebStd.gx_hidden_field( context, "vPERMISSIONACCESSTYPE_PREVIOUSVALUE", StringUtil.RTrim( AV59PermissionAccessType_PreviousValue));
         GxWebStd.gx_hidden_field( context, "gxhash_vPERMISSIONACCESSTYPE_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV59PermissionAccessType_PreviousValue, "")), context));
         ...
         GxWebStd.gx_hidden_field( context, "vCOUNTSELECTEDITEMS_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV62CountSelectedItems_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV39RoleId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vROLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV39RoleId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vAPPLICATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10ApplicationId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAPPLICATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ApplicationId), "ZZZZZZZZZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, "vROWSPERPAGE_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV46RowsPerPage_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vAVAILABLEPERMISSIONS_SELECTEDROWS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12AvailablePermissions_SelectedRows), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_hidden_field( context, "vMULTIROWITERATOR_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32MultiRowIterator_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vINDEX_AVAILABLEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53Index_AvailablePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "subAvailablepermissions_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subAvailablepermissions_Recordcount), 5, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "K2BT_GAM_AddPermission", "") ;
      }
      ...
      protected void WB490( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavApplicationname_Internalname, context.GetMessage( "K2BT_GAM_ApplicationName", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavGenericfilter_availablepermissions_Internalname, StringUtil.RTrim( AV66GenericFilter_AvailablePermissions), StringUtil.RTrim( context.localUtil.Format( AV66GenericFilter_AvailablePermissions, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "K2BT_GenericFilterInviteMessage", ""), edtavGenericfilter_availablepermissions_Jsonclick, 0, "K2BT_GenericFilter", "", "", "", "", 1, edtavGenericfilter_availablepermissions_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_K2BFSG\\RoleAddPermission.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavPermissionaccesstype_Internalname, context.GetMessage( "K2BT_GAM_DefaultAccessType", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavIsinherited_Internalname, context.GetMessage( "K2BT_GAM_IsInherited", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_availablepermissionsruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_availablepermissionsruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RoleAddPermission.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavGridsettingsrowsperpage_availablepermissions_Internalname, context.GetMessage( "K2BT_RowsPerPage", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavFreezecolumntitles_availablepermissions_Internalname, context.GetMessage( "K2BT_FreezeColumnTitles", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGridsettings_saveavailablepermissions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(124), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GridSettingsApply", ""), bttGridsettings_saveavailablepermissions_Jsonclick, 5, context.GetMessage( "K2BT_GridSettingsApply", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS(AVAILABLEPERMISSIONS)\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\RoleAddPermission.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START492( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_AddPermission", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP490( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_124 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "nRC_GXsfl_124"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV69DeletedTag_AvailablePermissions = cgiGet( "vDELETEDTAG_AVAILABLEPERMISSIONS");
            AV13CurrentPage_AvailablePermissions = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCURRENTPAGE_AVAILABLEPERMISSIONS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV53Index_AvailablePermissions = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vINDEX_AVAILABLEPERMISSIONS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV46RowsPerPage_AvailablePermissions = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vROWSPERPAGE_AVAILABLEPERMISSIONS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV23HasNextPage_AvailablePermissions = StringUtil.StrToBool( cgiGet( "vHASNEXTPAGE_AVAILABLEPERMISSIONS"));
            subAvailablepermissions_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( "subAvailablepermissions_Recordcount"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S252( )
      {
         ...
         if ( ! AV44hasError )
         {
            ...
            AV28Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Permissionsforhassuccessfullybeenadded", ""), AV19GAMRole.gxTpr_Name, "", "", "", "", "", "", "", "");
      ...
      protected void S132( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV34PermissionAccessType)) )
         {
            ...
            AV65K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = context.GetMessage( GeneXus.Programs.genexussecuritycommon.gxdomaingampermissionaccesstype.getDescription(context,AV34PermissionAccessType), "");
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV27IsInherited)) )
         {
            ...
            AV65K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = context.GetMessage( GeneXus.Programs.genexussecuritycommon.gxdomaingambooleanfilter.getDescription(context,AV27IsInherited), "");
            AV64K2BFilterValuesSDT_WebForm.Add(AV65K2BFilterValuesSDTItem_WebForm, 0);
         }
         Filtertagsusercontrol_availablepermissions_Emptystatemessage = context.GetMessage( "K2BT_FilterSummaryEmptyState", "");
      ...
      protected void wb_table1_132_492( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_availablepermissions_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_availablepermissions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RoleAddPermission.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221391080", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/roleaddpermission.js", "?202431221391082", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_1242( )
      {
         ...
         if ( ( cmbavAccess.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            ...
            cmbavAccess.WebTags = "";
            cmbavAccess.addItem("A", context.GetMessage( "Allow", ""), 0);
            cmbavAccess.addItem("D", context.GetMessage( "Deny", ""), 0);
            cmbavAccess.addItem("R", context.GetMessage( "Restricted", ""), 0);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavPermissionaccesstype.addItem("", context.GetMessage( "GX_AllItems", ""), 0);
         cmbavPermissionaccesstype.addItem("A", context.GetMessage( "Allow", ""), 0);
         cmbavPermissionaccesstype.addItem("D", context.GetMessage( "Deny", ""), 0);
         cmbavPermissionaccesstype.addItem("R", context.GetMessage( "Restricted", ""), 0);
         if ( cmbavPermissionaccesstype.ItemCount > 0 )
         {
            AV34PermissionAccessType = cmbavPermissionaccesstype.getValidValue(AV34PermissionAccessType);
            AssignAttri("", false, "AV34PermissionAccessType", AV34PermissionAccessType);
         ...
         cmbavIsinherited.addItem("A", context.GetMessage( "All", ""), 0);
         cmbavIsinherited.addItem("T", context.GetMessage( "Yes", ""), 0);
         cmbavIsinherited.addItem("F", context.GetMessage( "No", ""), 0);
         if ( cmbavIsinherited.ItemCount > 0 )
         {
            AV27IsInherited = cmbavIsinherited.getValidValue(AV27IsInherited);
            AssignAttri("", false, "AV27IsInherited", AV27IsInherited);
      ...
      public override void initialize_properties( )
      {
         ...
         chkavCheckall_availablepermissions.Caption = "";
         chkavFreezecolumntitles_availablepermissions.Caption = context.GetMessage( "K2BT_FreezeColumnTitles", "");
         edtavId_Jsonclick = "";
         edtavId_Visible = 0;
         edtavId_Enabled = 1;
         ...
         cmbavIsinherited.Caption = context.GetMessage( "K2BT_GAM_IsInherited", "");
         cmbavPermissionaccesstype.Caption = context.GetMessage( "K2BT_GAM_DefaultAccessType", "");
         ...
         Form.Caption = context.GetMessage( "K2BT_GAM_AddPermission", "");
