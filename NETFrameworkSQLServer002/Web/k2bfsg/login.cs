...
namespace GeneXus.Programs.k2bfsg {
   public class login : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( context.GetMessage( "GXM_Login", "")) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vUSERREMEMBERME", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV70UserRememberMe), 2, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAMOUNTOFCHARACTERS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10AmountOfCharacters), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "GXM_Login", "") ;
      }
      ...
      protected void WB3K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbexternalauthentication_Internalname, context.GetMessage( "Login using", ""), "", "", lblTbexternalauthentication_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /*  Grid Control  */
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV68UserName, StringUtil.RTrim( context.localUtil.Format( AV68UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "K2BT_GAM_Usernameoremail", ""), edtavUsername_Jsonclick, 0, "K2BT_LoginUsername", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "start", true, "", "HLP_K2BFSG\\Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblForgotpassword_action_Internalname, context.GetMessage( "K2BT_GAM_Forgotpassword", ""), "", "", lblForgotpassword_action_Jsonclick, "'"+""+"'"+",false,"+"'"+"e113k1_client"+"'", "", "K2BT_LoginSecondaryAction", 7, "", lblForgotpassword_action_Visible, 1, 0, 0, "HLP_K2BFSG\\Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCreateanaccount_action_Internalname, context.GetMessage( "K2BT_GAM_CreateAccount", ""), "", "", lblCreateanaccount_action_Jsonclick, "'"+""+"'"+",false,"+"'"+"e123k1_client"+"'", "", "K2BT_LoginSecondaryAction", 7, "", lblCreateanaccount_action_Visible, 1, 0, 0, "HLP_K2BFSG\\Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Div Control */
            ...
            ClassString = "CheckBoxAttribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavRememberme_Internalname, StringUtil.BoolToStr( AV57RememberMe), "", context.GetMessage( "K2BT_GAM_Rememberme", ""), chkavRememberme.Visible, chkavRememberme.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(63, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,63);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCaptchadescription_Internalname, context.GetMessage( "K2BT_GAM_Pleaseinsertthetextbelow", ""), "", "", lblCaptchadescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", lblCaptchadescription_Visible, 1, 0, 0, "HLP_K2BFSG\\Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
      ...
      protected void START3K2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "GXM_Login", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP3K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            divExternalauthentications_Visible = (int)(Math.Round(context.localUtil.CToN( cgiGet( "EXTERNALAUTHENTICATIONS_Visible"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         if ( AV25ConnectionInfoCollection.Count > 1 )
         {
            ...
            lblCurrentrepository_Caption = context.GetMessage( "K2BT_GAM_Repository:", "")+AV34GAMRepository.gxTpr_Name;
         ...
         if ( ! AV45isRedirect )
         {
            ...
            if ( AV61SessionValid && ! AV60Session.gxTpr_Isanonymous )
            {
               ...
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV67URL)) )
               {
                  ...
                  CallWebObject(formatLink("wwsoporte.aspx") );
                  context.wjLocDisableFrm = 1;
               }
               else
               {
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         new k2bsessionget(context ).execute(  "SessionCaptchaActive", out  AV22CaptchaRequiredText) ;
         if ( StringUtil.StrCmp(AV22CaptchaRequiredText, context.GetMessage( "true", "")) == 0 )
         {
            ...
            AV80Captchaimage_GXI = GXDbFile.PathToUrl( context.GetMessage( "data:image/jpeg;charset=utf-8;base64,", "")+AV16Base64String);
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV19CaptchaImage)) ? AV80Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV19CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV19CaptchaImage), true);
         }
         else
         {
            ...
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV19CaptchaImage)) ? AV80Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV19CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV19CaptchaImage), true);
            AV80Captchaimage_GXI = GXDbFile.PathToUrl( context.GetMessage( "data:image/jpeg;charset=utf-8;base64,R0lGODlhAQABAPAAAP///////ywAAAAAAQABAEAIBAABBAQAOw==", ""));
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV19CaptchaImage)) ? AV80Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV19CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV19CaptchaImage), true);
         }
      }
      ...
      private void E173K2( )
      {
         ...
         while ( AV81GXV7 <= AV14AuthenticationTypes.Count )
         {
            ...
            if ( AV13AuthenticationType.gxTpr_Redirtoauthenticate )
            {
               ...
               AssignAttri("", false, edtavNameauthtype_Internalname, AV55NameAuthType);
               GxWebStd.gx_hidden_field( context, "gxhash_vNAMEAUTHTYPE"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sGXsfl_20_idx, StringUtil.RTrim( context.localUtil.Format( AV55NameAuthType, "")), context));
               edtavImageauthtype_Tooltiptext = StringUtil.Format( context.GetMessage( "K2BT_GAM_SignInWith", ""), StringUtil.Trim( AV13AuthenticationType.gxTpr_Description), "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243131136154", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/login.js", "?20243131136158", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         divExternalauthentications_Visible = 1;
         lblCurrentrepository_Caption = context.GetMessage( "Text Block", "");
         lblCurrentrepository_Visible = 1;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
