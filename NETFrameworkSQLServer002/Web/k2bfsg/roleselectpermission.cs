   ...
   public class roleselectpermission : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_RoleSelectPermission", "")) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vAPPLICATIONID_PREVIOUSVALUE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV75ApplicationId_PreviousValue), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vI_LOADCOUNT_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35I_LoadCount_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_113", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_113), 8, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6RoleId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6RoleId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCURRENTPAGE_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15CurrentPage_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGENERICFILTER_PREVIOUSVALUE_ACTIVEPERMISSIONS", StringUtil.RTrim( AV92GenericFilter_PreviousValue_ActivePermissions));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vGENERICFILTER_PREVIOUSVALUE_ACTIVEPERMISSIONS", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV92GenericFilter_PreviousValue_ActivePermissions, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vAPPLICATIONID_PREVIOUSVALUE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV75ApplicationId_PreviousValue), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vAPPLICATIONID_PREVIOUSVALUE", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV75ApplicationId_PreviousValue), "ZZZZZZZZZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6RoleId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV98Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV98Pgmname, "")), context));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vCOUNTSELECTEDITEMS_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV77CountSelectedItems_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vROWSPERPAGE_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV61RowsPerPage_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vACTIVEPERMISSIONS_SELECTEDROWS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ActivePermissions_SelectedRows), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vI_LOADCOUNT_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35I_LoadCount_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vI_LOADCOUNT_ACTIVEPERMISSIONS", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV35I_LoadCount_ActivePermissions), "ZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vHASNEXTPAGE_ACTIVEPERMISSIONS", AV32HasNextPage_ActivePermissions);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASNEXTPAGE_ACTIVEPERMISSIONS", GetSecureSignedToken( sPrefix, AV32HasNextPage_ActivePermissions, context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMULTIROWITERATOR_ACTIVEPERMISSIONS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV47MultiRowIterator_ActivePermissions), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"subActivepermissions_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subActivepermissions_Recordcount), 5, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "K2BT_GAM_RoleSelectPermission", "") ;
      }
      ...
      protected void WB3X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, cmbavApplicationid_Internalname, context.GetMessage( "K2BT_GAM_Application", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_activepermissionsruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_activepermissionsruntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RoleSelectPermission.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavGridsettingsrowsperpage_activepermissions_Internalname, context.GetMessage( "K2BT_RowsPerPage", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavFreezecolumntitles_activepermissions_Internalname, context.GetMessage( "K2BT_FreezeColumnTitles", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavFreezecolumntitles_activepermissions_Internalname, StringUtil.BoolToStr( AV91FreezeColumnTitles_ActivePermissions), "", context.GetMessage( "K2BT_FreezeColumnTitles", ""), 1, chkavFreezecolumntitles_activepermissions.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(84, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,84);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGridsettings_saveactivepermissions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(113), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GridSettingsApply", ""), bttGridsettings_saveactivepermissions_Jsonclick, 5, context.GetMessage( "K2BT_GridSettingsApply", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'SAVEGRIDSETTINGS(ACTIVEPERMISSIONS)\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\RoleSelectPermission.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3X2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_RoleSelectPermission", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void STRUP3X0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_113 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_113"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV94DeletedTag_ActivePermissions = cgiGet( sPrefix+"vDELETEDTAG_ACTIVEPERMISSIONS");
            wcpOAV6RoleId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6RoleId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV15CurrentPage_ActivePermissions = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vCURRENTPAGE_ACTIVEPERMISSIONS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV61RowsPerPage_ActivePermissions = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vROWSPERPAGE_ACTIVEPERMISSIONS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV32HasNextPage_ActivePermissions = StringUtil.StrToBool( cgiGet( sPrefix+"vHASNEXTPAGE_ACTIVEPERMISSIONS"));
            subActivepermissions_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"subActivepermissions_Recordcount"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S252( )
      {
         ...
         if ( ! AV60hasError )
         {
            GX_msglist.addItem(StringUtil.Format( context.GetMessage( "K2BT_GAM_Permissionssuccesfullyremovedforrole", ""), AV5GAMRole.gxTpr_Name, "", "", "", "", "", "", "", ""));
      ...
      protected void E173X2( )
      {
         ...
         if ( ! AV45MultiRowHasNext_ActivePermissions )
         {
            ...
            new k2btoolsmsg(context ).execute(  context.GetMessage( "K2BT_NoRowsSelectedError", ""),  0) ;
         }
         else
         {
      ...
      protected void S302( )
      {
         ...
         imgDeletemultiple_Tooltiptext = context.GetMessage( "K2BT_DeleteAction", "");
      ...
      protected void S132( )
      {
         ...
         Filtertagsusercontrol_activepermissions_Emptystatemessage = context.GetMessage( "K2BT_FilterSummaryEmptyState", "");
      ...
      protected void S342( )
      {
         ...
         {
            context.CommitDataStores("k2bfsg.roleselectpermission",pr_default);
            GX_msglist.addItem(StringUtil.Format( context.GetMessage( "K2BT_GAM_Therolewasupdated", ""), AV5GAMRole.gxTpr_Name, "", "", "", "", "", "", "", ""));
         }
         else
         {
            AV110GXV11 = 1;
      ...
      protected void wb_table1_125_3X2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_activepermissions_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_activepermissions_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\RoleSelectPermission.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6RoleId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6RoleId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6RoleId", StringUtil.LTrimStr( (decimal)(AV6RoleId), 12, 0));
         }
         else
         {
            AV6RoleId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6RoleId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6RoleId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6RoleId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243122134697", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/roleselectpermission.js", "?2024312213475", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_1132( )
      {
         ...
         cmbavAccesstype.addItem("D", context.GetMessage( "Deny", ""), 0);
         ...
         if ( ( cmbavStoredaccesstype.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            ...
            cmbavStoredaccesstype.addItem("A", context.GetMessage( "Allow", ""), 0);
            cmbavStoredaccesstype.addItem("D", context.GetMessage( "Deny", ""), 0);
            cmbavStoredaccesstype.addItem("R", context.GetMessage( "Restricted", ""), 0);
      ...
      protected void StartGridControl113( )
      {
         if ( ActivepermissionsContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_IsInherited", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         chkavCheckall_activepermissions.Caption = "";
         chkavFreezecolumntitles_activepermissions.Caption = context.GetMessage( "K2BT_FreezeColumnTitles", "");
         ...
         cmbavApplicationid.Caption = context.GetMessage( "K2BT_GAM_Application", "");
         ...
         Gridcomponent_activepermissions_Title = context.GetMessage( "K2BT_GAM_Permissions", "");
