...
namespace GeneXus.Programs.k2bfsg {
   public class changerepository : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9CurrentPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_28", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_28), 8, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9CurrentPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTPAGE_GRID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9CurrentPage_Grid), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV28Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV28Pgmname, "")), context));
      ...
      {
         return context.GetMessage( "Change Repository", "") ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_ChangeRepository", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\ChangeRepository.htm");
      ...
      protected void START3F2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Change Repository", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP3F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_28 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "nRC_GXsfl_28"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      private void E143F2( )
      {
         ...
         while ( true )
         {
            ...
            S172 ();
            if (returnInSub) return;
            AV23SetActive_Action = context.GetMessage( "K2BT_GAM_SetActive", "");
            AssignAttri("", false, edtavSetactive_action_Internalname, AV23SetActive_Action);
      ...
      protected void S172( )
      {
         ...
         if ( AV7ConnectionInfoCollection.Count >= AV17I_LoadCount_Grid )
         {
            ...
            {
               AV24Status = context.GetMessage( "K2BT_GAM_Active", "");
               AssignAttri("", false, edtavStatus_Internalname, AV24Status);
      ...
      protected void S192( )
      {
         ...
         else
         {
            if ( AV19OK )
            {
               GX_msglist.addItem(context.GetMessage( "Connection Changed", ""));
      ...
      protected void wb_table1_35_3F2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\ChangeRepository.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221355962", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/changerepository.js", "?202431221355968", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void StartGridControl28( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_Repository", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Change Repository", "");
