      ...
      void executePrivate( )
      {
         ...
         if ( AV13GetUserErrors.Count == 0 )
         {
            ...
            if ( AV10Errors.Count == 0 )
            {
               ...
               AV11GAMUserAttribute.gxTpr_Value = context.localUtil.TToC( AV17Now, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " ");
               AV12GAMUserAux.setattribute( AV11GAMUserAttribute, out  AV10Errors);
            }
            else
            {
