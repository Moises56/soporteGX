...
namespace GeneXus.Programs.k2bfsg {
   public class entrymenu : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return context.GetMessage( "GXM_Menu", "") ;
      }
      ...
      protected void WB4H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavApplicationdescription_Internalname, context.GetMessage( "K2BT_GAM_Application", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavMenuname_Internalname, context.GetMessage( "K2BT_GAM_Name", ""), "gx-form-item Attribute_TrnLabel Attribute_RequiredLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_var_guid_Internalname, context.GetMessage( "K2BT_GUID", ""), "", "", lblTextblock_var_guid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryMenu.htm");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavGuid_Internalname, context.GetMessage( "K2BT_GUID", ""), "gx-form-item Attribute_TrnLabel", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancel_Internalname, "", context.GetMessage( "GX_BtnCancel", ""), bttCancel_Jsonclick, 5, "", "", StyleString, ClassString, bttCancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_CANCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\EntryMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START4H2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "GXM_Menu", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E124H2( )
      {
         ...
         S122 ();
         if (returnInSub) return;
         imgGuid_var_contexthelpimage_Tooltiptext = context.GetMessage( "K2BT_GAM_Ifemptyitwillbegeneratedautomatically", "");
      ...
      protected void S152( )
      {
         ...
         if ( AV14isOk )
         {
            ...
            if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
            {
               AV18Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Themenuwascreated", ""), AV17MenuName, "", "", "", "", "", "", "", "");
            }
            if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
            {
               AV18Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Themenuwasupdated", ""), AV17MenuName, "", "", "", "", "", "", "", "");
            }
            if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
            {
               AV18Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Themenuwasdeleted", ""), AV17MenuName, "", "", "", "", "", "", "", "");
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221395023", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/entrymenu.js", "?202431221395024", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "GXM_Menu", "");
