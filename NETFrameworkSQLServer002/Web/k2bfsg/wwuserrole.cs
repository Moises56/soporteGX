   ...
   public class wwuserrole : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_WWUserRole", "")) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vI_LOADCOUNT_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31I_LoadCount_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISDIRECTROLE", AV18isDirectRole);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISDIRECTROLE", GetSecureSignedToken( sPrefix, AV18isDirectRole, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCURRENTPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29CurrentPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRID_SELECTEDROWS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV58Grid_SelectedRows), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vI_LOADCOUNT_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31I_LoadCount_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vI_LOADCOUNT_GRID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV31I_LoadCount_Grid), "ZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vHASNEXTPAGE_GRID", AV63HasNextPage_Grid);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASNEXTPAGE_GRID", GetSecureSignedToken( sPrefix, AV63HasNextPage_Grid, context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vCOUNTSELECTEDITEMS_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57CountSelectedItems_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vMULTIROWHASNEXT_GRID", AV47MultiRowHasNext_Grid);
         GxWebStd.gx_hidden_field( context, sPrefix+"vMULTIROWITERATOR_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV48MultiRowIterator_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vS_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV61S_Id), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return context.GetMessage( "K2BT_GAM_WWUserRole", "") ;
      }
      ...
      protected void WB420( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLayoutdefined_k2bt_filtercaption_grid_Internalname, context.GetMessage( "K2BT_Filters", ""), "", "", lblLayoutdefined_k2bt_filtercaption_grid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BT_FilterToggleText", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUserRole.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_label_element( context, chkavDisplayinheritroles_Internalname, context.GetMessage( "K2BT_GAM_DisplayInheritRole", ""), "gx-form-item AttributeLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAdd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(76), 2, 0)+","+"null"+");", context.GetMessage( "K2BT_InsertAction", ""), bttAdd_Jsonclick, 5, "", "", StyleString, ClassString, bttAdd_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'E_ADD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\WWUserRole.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START422( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_WWUserRole", ""), 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'E_DELETE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "'E_MAINROLE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 32), "VMULTIROWITEMSELECTED_GRID.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 32), "VMULTIROWITEMSELECTED_GRID.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "'E_MAINROLE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'E_DELETE'") == 0 ) )
                           {
                              ...
                              {
                                 AV36Id = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
                                 AssignAttri(sPrefix, false, edtavId_Internalname, StringUtil.LTrimStr( (decimal)(AV36Id), 12, 0));
                                 GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vID"+"_"+sGXsfl_76_idx, GetSecureSignedToken( sPrefix+sGXsfl_76_idx, context.localUtil.Format( (decimal)(AV36Id), "ZZZZZZZZZZZ9"), context));
                              }
      ...
      protected void STRUP420( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV29CurrentPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vCURRENTPAGE_GRID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S142( )
      {
         ...
         if ( AV16isOK )
         {
            GX_msglist.addItem(context.GetMessage( "K2BT_GAM_Rolewassuccesffullydeleted", ""));
            gxgrGrid_refresh( AV38DisplayInheritRoles_PreviousValue, AV54AllSelectedItems_Grid, AV49ClassCollection_Grid, AV37DisplayInheritRoles, AV67Pgmname, AV29CurrentPage_Grid, AV57CountSelectedItems_Grid, AV63HasNextPage_Grid, AV18isDirectRole, AV36Id, AV58Grid_SelectedRows, AV17UserId, AV31I_LoadCount_Grid, AV50CheckAll_Grid, sPrefix) ;
         }
      }
      ...
      protected void S152( )
      {
         ...
         {
            context.CommitDataStores("k2bfsg.wwuserrole",pr_default);
            GX_msglist.addItem(context.GetMessage( "K2BT_GAM_Rolewassuccessfullysetasmain", ""));
            gxgrGrid_refresh( AV38DisplayInheritRoles_PreviousValue, AV54AllSelectedItems_Grid, AV49ClassCollection_Grid, AV37DisplayInheritRoles, AV67Pgmname, AV29CurrentPage_Grid, AV57CountSelectedItems_Grid, AV63HasNextPage_Grid, AV18isDirectRole, AV36Id, AV58Grid_SelectedRows, AV17UserId, AV31I_LoadCount_Grid, AV50CheckAll_Grid, sPrefix) ;
         }
         else
         {
      ...
      private void E21422( )
      {
         ...
         while ( true )
         {
            ...
            S162 ();
            if (returnInSub) return;
            AV33MainRole_Action = context.GetMessage( "K2BT_GAM_SetAsMain", "");
            AssignAttri(sPrefix, false, edtavMainrole_action_Internalname, AV33MainRole_Action);
            if ( ! AV18isDirectRole )
            {
      ...
      protected void S162( )
      {
         ...
         if ( ! AV37DisplayInheritRoles )
         {
            if ( AV31I_LoadCount_Grid == 1 )
            {
               ...
               AV13Roles.Sort(context.GetMessage( "Description", ""));
            }
            if ( AV13Roles.Count >= AV31I_LoadCount_Grid )
            {
               ...
               {
                  AV33MainRole_Action = context.GetMessage( "K2BT_GAM_SetMain", "");
                  AssignAttri(sPrefix, false, edtavMainrole_action_Internalname, AV33MainRole_Action);
               }
      ...
      protected void S132( )
      {
         ...
         if ( ! (false==AV37DisplayInheritRoles) )
         {
            ...
            AV40K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = context.GetMessage( "GXM_Yes", "");
      ...
      protected void S282( )
      {
         ...
         imgMultipledelete_Tooltiptext = context.GetMessage( "Multiple Delete", "");
      ...
      protected void wb_table1_85_422( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUserRole.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221325624", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/wwuserrole.js", "?202431221325627", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_762( )
      {
         ...
         ROClassString = "Attribute_Grid";
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36Id), 12, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtavId_Enabled!=0) ? context.localUtil.Format( (decimal)(AV36Id), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV36Id), "ZZZZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,80);\"" : " "),(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(int)edtavId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)76,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMKeyNumLong",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         chkavDisplayinheritroles.Caption = context.GetMessage( "K2BT_GAM_DisplayInheritRole", "");
         ...
         Gridcomponent_grid_Title = context.GetMessage( "K2BT_GAM_Roles", "");
