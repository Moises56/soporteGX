...
namespace GeneXus.Programs.k2bfsg {
   public class testauthenticationtype : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public testauthenticationtype( )
      {
      ...
      public testauthenticationtype( IGxContext context )
      {
                           ...
                           ref string aP1_TypeId )
      {
         ...
         this.AV16TypeId = aP1_TypeId;
         executePrivate();
         aP0_Name=this.AV13Name;
         aP1_TypeId=this.AV16TypeId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV13Name = gxfirstwebparm;
               AssignAttri("", false, "AV13Name", AV13Name);
               GxWebStd.gx_hidden_field( context, "gxhash_vNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13Name, "")), context));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV16TypeId = GetPar( "TypeId");
                  AssignAttri("", false, "AV16TypeId", AV16TypeId);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2bfsg.testauthenticationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV13Name)),UrlEncode(StringUtil.RTrim(AV16TypeId))}, new string[] {"Name","TypeId"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vNAME", StringUtil.RTrim( AV13Name));
         GxWebStd.gx_hidden_field( context, "gxhash_vNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13Name, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vNAME", StringUtil.RTrim( AV13Name));
         GxWebStd.gx_hidden_field( context, "gxhash_vNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13Name, "")), context));
         GxWebStd.gx_hidden_field( context, "vTYPEID", StringUtil.RTrim( AV16TypeId));
      ...
      {
         return formatLink("k2bfsg.testauthenticationtype.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV13Name)),UrlEncode(StringUtil.RTrim(AV16TypeId))}, new string[] {"Name","TypeId"})  ;
      }

      public override string GetPgmname( )
      {
         return "K2BFSG.TestAuthenticationType" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Test Authentication Type", "") ;
      }
      ...
      protected void WB3U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, lblTitle_Caption, "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\TestAuthenticationType.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 col-sm-offset-4", "start", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, StringUtil.RTrim( AV17UserName), StringUtil.RTrim( context.localUtil.Format( AV17UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsername_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 0, "px", 1, "row", 254, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionLong", "start", true, "", "HLP_K2BFSG\\TestAuthenticationType.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, context.GetMessage( "K2BT_GAM_Password", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV18UserPassword), StringUtil.RTrim( context.localUtil.Format( AV18UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUserpassword_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUserpassword_Enabled, 0, "text", "", 0, "px", 1, "row", 254, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionLong", "start", true, "", "HLP_K2BFSG\\TestAuthenticationType.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttTest_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttTest_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\TestAuthenticationType.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3U2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Test Authentication Type", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP3U0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AssignAttri("", false, "AV17UserName", AV17UserName);
            AV18UserPassword = cgiGet( edtavUserpassword_Internalname);
            AssignAttri("", false, "AV18UserPassword", AV18UserPassword);
      ...
      protected void S112( )
      {
         /* 'U_OPENPAGE' Routine */
         returnInSub = false;
         lblTitle_Caption = StringUtil.Format( context.GetMessage( "K2BT_GAM_TestAuthenticationType", ""), AV13Name, "", "", "", "", "", "", "", "");
      ...
      protected void E133U2( )
      {
         /* Enter Routine */
         returnInSub = false;
         /* Execute user subroutine: 'U_TEST' */
         S142 ();
         if (returnInSub) return;
      ...
      protected void S142( )
      {
         /* 'U_TEST' Routine */
         returnInSub = false;
         AV7AdditionalParameter.gxTpr_Authenticationtypename = AV13Name;
         AV7AdditionalParameter.gxTpr_Isbatch = true;
         AV11LoginOk = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV17UserName, AV18UserPassword, AV7AdditionalParameter, out  AV9Errors);
         if ( AV11LoginOk && ( AV9Errors.Count == 0 ) )
         {
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV13Name = (string)getParm(obj,0);
         AssignAttri("", false, "AV13Name", AV13Name);
         GxWebStd.gx_hidden_field( context, "gxhash_vNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13Name, "")), context));
         AV16TypeId = (string)getParm(obj,1);
         AssignAttri("", false, "AV16TypeId", AV16TypeId);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221372586", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/testauthenticationtype.js", "?202431221372590", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         lblTitle_Caption = context.GetMessage( "K2BT_GAM_TestAuthenticationType", "");
         ...
         Attributes_Title = context.GetMessage( "K2BT_GAM_AuthenticationTypeTestDescription", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "Test Authentication Type", "");
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV13Name',fld:'vNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E133U2',iparms:[{av:'AV13Name',fld:'vNAME',pic:'',hsh:true},{av:'AV17UserName',fld:'vUSERNAME',pic:''},{av:'AV18UserPassword',fld:'vUSERPASSWORD',pic:''}]");
      ...
      private string AV16TypeId ;
      private string wcpOAV13Name ;
      private string wcpOAV16TypeId ;
      ...
      private string bttTest_Internalname ;
      private string bttTest_Jsonclick ;
