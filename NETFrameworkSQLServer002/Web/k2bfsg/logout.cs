...
namespace GeneXus.Programs.k2bfsg {
   public class logout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public logout( )
      {
      ...
      public logout( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2bfsg.logout.aspx") +"\">") ;
      ...
      {
         return formatLink("k2bfsg.logout.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "K2BFSG.Logout" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "GXM_Logout", "") ;
      }
      ...
      protected void WB450( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_452( true) ;
         }
         else
         {
            wb_table1_6_452( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_452e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START452( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "GXM_Logout", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP450( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV9ConfirmMessage = cgiGet( edtavConfirmmessage_Internalname);
            AssignAttri("", false, "AV9ConfirmMessage", AV9ConfirmMessage);
      ...
      protected void E11452( )
      {
         /* Start Routine */
         returnInSub = false;
         AV9ConfirmMessage = context.GetMessage( "K2BT_GAM_LogoutConfirmation", "");
         AssignAttri("", false, "AV9ConfirmMessage", AV9ConfirmMessage);
      }
      ...
      protected void wb_table1_6_452( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_452( true) ;
         }
         else
         {
            wb_table2_9_452( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_452e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table1_6_452e( true) ;
         }
         else
         {
            wb_table1_6_452e( false) ;
         }
      }

      protected void wb_table2_9_452( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_12_452( true) ;
         }
         else
         {
            wb_table3_12_452( false) ;
         }
         return  ;
      }

      protected void wb_table3_12_452e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_452e( true) ;
         }
         else
         {
            wb_table2_9_452e( false) ;
         }
      }

      protected void wb_table3_12_452( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavConfirmmessage_Internalname, StringUtil.RTrim( AV9ConfirmMessage), StringUtil.RTrim( context.localUtil.Format( AV9ConfirmMessage, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConfirmmessage_Jsonclick, 0, "Attribute_ConditionalConfirm", "", "", "", "", 1, edtavConfirmmessage_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_K2BFSG\\Logout.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_19_452( true) ;
         }
         else
         {
            wb_table4_19_452( false) ;
         }
         return  ;
      }

      protected void wb_table4_19_452e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_12_452e( true) ;
         }
         else
         {
            wb_table3_12_452e( false) ;
         }
      }

      protected void wb_table4_19_452( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmyes_Internalname, "", context.GetMessage( "K2BT_ConfirmOk", ""), bttI_buttonconfirmyes_Jsonclick, 5, context.GetMessage( "K2BT_ConfirmOk", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMYES\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\Logout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 24,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmno_Internalname, "", context.GetMessage( "K2BT_ConfirmCancel", ""), bttI_buttonconfirmno_Jsonclick, 5, context.GetMessage( "K2BT_ConfirmCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMNO\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\Logout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_19_452e( true) ;
         }
         else
         {
            wb_table4_19_452e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221374447", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/logout.js", "?202431221374447", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "GXM_Logout", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E12452',iparms:[]");
         setEventMetadata("'CONFIRMYES'",",oparms:[]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E13452',iparms:[]");
      ...
      private string AV9ConfirmMessage ;
