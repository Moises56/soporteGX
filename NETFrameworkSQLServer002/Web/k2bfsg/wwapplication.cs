...
namespace GeneXus.Programs.k2bfsg {
   public class wwapplication : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwapplication( )
      {
      ...
      public wwapplication( IGxContext context )
      {
      ...
      {
         AV31FilName_PreviousValue = GetPar( "FilName_PreviousValue");
         AV32FilDescription_PreviousValue = GetPar( "FilDescription_PreviousValue");
         AV12FilName = GetPar( "FilName");
         AV11FilDescription = GetPar( "FilDescription");
         ...
         gxgrGrid_refresh( AV31FilName_PreviousValue, AV32FilDescription_PreviousValue, AV12FilName, AV11FilDescription, AV44Pgmname, AV8CurrentPage_Grid, AV18HasNextPage_Grid, AV38GridConfiguration, AV41ClassCollection_Grid, AV29RowsPerPage_Grid, AV20I_LoadCount_Grid, AV42FreezeColumnTitles_Grid) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2bfsg.wwapplication.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vFILNAME_PREVIOUSVALUE", StringUtil.RTrim( AV31FilName_PreviousValue));
         GxWebStd.gx_hidden_field( context, "gxhash_vFILNAME_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV31FilName_PreviousValue, "")), context));
         GxWebStd.gx_hidden_field( context, "vFILDESCRIPTION_PREVIOUSVALUE", StringUtil.RTrim( AV32FilDescription_PreviousValue));
         GxWebStd.gx_hidden_field( context, "gxhash_vFILDESCRIPTION_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV32FilDescription_PreviousValue, "")), context));
         ...
         GxWebStd.gx_hidden_field( context, "vI_LOADCOUNT_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20I_LoadCount_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vHASNEXTPAGE_GRID", AV18HasNextPage_Grid);
         GxWebStd.gx_hidden_field( context, "gxhash_vHASNEXTPAGE_GRID", GetSecureSignedToken( "", AV18HasNextPage_Grid, context));
         GxWebStd.gx_hidden_field( context, "vROWSPERPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29RowsPerPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vI_LOADCOUNT_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20I_LoadCount_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vI_LOADCOUNT_GRID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV20I_LoadCount_Grid), "ZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, "vFILDESCRIPTION_Caption", StringUtil.RTrim( edtavFildescription_Caption));
      ...
      {
         return formatLink("k2bfsg.wwapplication.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "K2BFSG.WWApplication" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "K2BT_GAM_Applications", "") ;
      }
      ...
      protected void WB3A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_Applications", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            ...
            GxWebStd.gx_bitmap( context, imgLayoutdefined_filtertoggle_onlydetailed_grid_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgLayoutdefined_filtertoggle_onlydetailed_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e113a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLayoutdefined_k2bt_filtercaption_grid_Internalname, context.GetMessage( "K2BT_Filters", ""), "", "", lblLayoutdefined_k2bt_filtercaption_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_FilterToggleText", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilname_Internalname, StringUtil.RTrim( AV12FilName), StringUtil.RTrim( context.localUtil.Format( AV12FilName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFilname_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavFilname_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionShort", "start", true, "", "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTable_container_fildescription_Internalname, 1, 0, "px", 0, "px", "K2BT_NGA K2BToolsTable_TopAttributeContainer", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group gx-label-top", "start", "top", ""+" data-gx-for=\""+edtavFildescription_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFildescription_Internalname, context.GetMessage( "K2BT_GAM_Description", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'',false,'" + sGXsfl_102_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFildescription_Internalname, StringUtil.RTrim( AV11FilDescription), StringUtil.RTrim( context.localUtil.Format( AV11FilDescription, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFildescription_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavFildescription_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionShort", "start", true, "", "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,80);\"", "", true, 0, "HLP_K2BFSG\\WWApplication.htm");
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttNew_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(102), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_InsertAction", ""), bttNew_Jsonclick, 7, "", "", StyleString, ClassString, bttNew_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e133a1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 102 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_110_3A2( true) ;
         }
         else
         {
            wb_table1_110_3A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_110_3A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e143a1_client"+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e153a1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgrid_Internalname, lblPaginationbar_previouspagetextblockgrid_Caption, "", "", lblPaginationbar_previouspagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e143a1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_previouspagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgrid_Internalname, lblPaginationbar_currentpagetextblockgrid_Caption, "", "", lblPaginationbar_currentpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e163a1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e163a1_client"+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3A2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_Applications", ""), 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              {
                                 AV21Id = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
                                 AssignAttri("", false, edtavId_Internalname, StringUtil.LTrimStr( (decimal)(AV21Id), 12, 0));
                              }
                              AV17GUID = cgiGet( edtavGuid_Internalname);
                              AssignAttri("", false, edtavGuid_Internalname, AV17GUID);
                              AV36Update_Action = cgiGet( edtavUpdate_action_Internalname);
                              AssignProp("", false, edtavUpdate_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update_Action)) ? AV45Update_action_GXI : context.convertURL( context.PathToRelativeUrl( AV36Update_Action))), !bGXsfl_102_Refreshing);
                              AssignProp("", false, edtavUpdate_action_Internalname, "SrcSet", context.GetImageSrcSet( AV36Update_Action), true);
      ...
      protected void gxgrGrid_refresh( string AV31FilName_PreviousValue ,
                                       string AV32FilDescription_PreviousValue ,
                                       string AV12FilName ,
                                       string AV11FilDescription ,
                                       string AV44Pgmname ,
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV30GridSettingsRowsPerPage_Grid = (short)(Math.Round(NumberUtil.Val( cmbavGridsettingsrowsperpage_grid.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0))), "."), 18, MidpointRounding.ToEven));
            AssignAttri("", false, "AV30GridSettingsRowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0));
      ...
      {
         /* GeneXus formulas. */
         AV44Pgmname = "K2BFSG.WWApplication";
         edtavName_Enabled = 0;
         AssignProp("", false, edtavName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavName_Enabled), 5, 0), !bGXsfl_102_Refreshing);
         edtavId_Enabled = 0;
         AssignProp("", false, edtavId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavId_Enabled), 5, 0), !bGXsfl_102_Refreshing);
         edtavGuid_Enabled = 0;
         AssignProp("", false, edtavGuid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavGuid_Enabled), 5, 0), !bGXsfl_102_Refreshing);
      }
      ...
      protected void STRUP3A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV29RowsPerPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vROWSPERPAGE_GRID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            ...
            edtavFildescription_Caption = cgiGet( "vFILDESCRIPTION_Caption");
            /* Read variables values. */
            AV12FilName = cgiGet( edtavFilname_Internalname);
            AssignAttri("", false, "AV12FilName", AV12FilName);
            AV11FilDescription = cgiGet( edtavFildescription_Internalname);
            AssignAttri("", false, "AV11FilDescription", AV11FilDescription);
            ...
            AV30GridSettingsRowsPerPage_Grid = (short)(Math.Round(NumberUtil.Val( cgiGet( cmbavGridsettingsrowsperpage_grid_Internalname), "."), 18, MidpointRounding.ToEven));
            AssignAttri("", false, "AV30GridSettingsRowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0));
      ...
      protected void S142( )
      {
         ...
         {
            AV22Message = ((GeneXus.Utils.SdtMessages_Message)AV28Messages.Item(AV43GXV1));
      ...
      protected void E183A2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV44Pgmname,  "Grid", out  AV29RowsPerPage_Grid, out  AV33RowsPerPageLoaded_Grid) ;
         AssignAttri("", false, "AV29RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV29RowsPerPage_Grid), 4, 0));
         if ( ! AV33RowsPerPageLoaded_Grid )
         {
            AV29RowsPerPage_Grid = 20;
            AssignAttri("", false, "AV29RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV29RowsPerPage_Grid), 4, 0));
         }
         AV30GridSettingsRowsPerPage_Grid = AV29RowsPerPage_Grid;
         AssignAttri("", false, "AV30GridSettingsRowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV30GridSettingsRowsPerPage_Grid), 4, 0));
         ...
         S122 ();
         if (returnInSub) return;
         AV31FilName_PreviousValue = AV12FilName;
         AssignAttri("", false, "AV31FilName_PreviousValue", AV31FilName_PreviousValue);
         GxWebStd.gx_hidden_field( context, "gxhash_vFILNAME_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV31FilName_PreviousValue, "")), context));
         AV32FilDescription_PreviousValue = AV11FilDescription;
         AssignAttri("", false, "AV32FilDescription_PreviousValue", AV32FilDescription_PreviousValue);
         GxWebStd.gx_hidden_field( context, "gxhash_vFILDESCRIPTION_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV32FilDescription_PreviousValue, "")), context));
      ...
      protected void E193A2( )
      {
         ...
         if ( StringUtil.StrCmp(AV31FilName_PreviousValue, AV12FilName) != 0 )
         {
            AV31FilName_PreviousValue = AV12FilName;
            AssignAttri("", false, "AV31FilName_PreviousValue", AV31FilName_PreviousValue);
            GxWebStd.gx_hidden_field( context, "gxhash_vFILNAME_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV31FilName_PreviousValue, "")), context));
         ...
         if ( StringUtil.StrCmp(AV32FilDescription_PreviousValue, AV11FilDescription) != 0 )
         {
            AV32FilDescription_PreviousValue = AV11FilDescription;
            AssignAttri("", false, "AV32FilDescription_PreviousValue", AV32FilDescription_PreviousValue);
            GxWebStd.gx_hidden_field( context, "gxhash_vFILDESCRIPTION_PREVIOUSVALUE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV32FilDescription_PreviousValue, "")), context));
      ...
      protected void S182( )
      {
         /* 'U_NEW' Routine */
         returnInSub = false;
         CallWebObject(formatLink("k2bfsg.entryapplication.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","Id"}) );
      ...
      protected void S192( )
      {
         /* 'U_UPDATE' Routine */
         returnInSub = false;
         CallWebObject(formatLink("k2bfsg.entryapplication.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV21Id,12,0))}, new string[] {"Mode","Id"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S202( )
      {
         /* 'U_DELETE' Routine */
         returnInSub = false;
         CallWebObject(formatLink("k2bfsg.entryapplication.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV21Id,12,0))}, new string[] {"Mode","Id"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      private void E203A2( )
      {
         ...
         while ( true )
         {
            ...
            AV36Update_Action = context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( ));
            AssignAttri("", false, edtavUpdate_action_Internalname, AV36Update_Action);
      ...
      protected void S212( )
      {
         ...
         if ( AV20I_LoadCount_Grid == 1 )
         {
            ...
            AV13Filter.gxTpr_Description = AV11FilDescription;
            AV7Applications = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV13Filter, out  AV9Errors);
         }
         if ( AV7Applications.Count >= AV20I_LoadCount_Grid )
         {
            AV23Name = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV7Applications.Item(AV20I_LoadCount_Grid)).gxTpr_Name;
            AssignAttri("", false, edtavName_Internalname, AV23Name);
            AV21Id = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV7Applications.Item(AV20I_LoadCount_Grid)).gxTpr_Id;
            AssignAttri("", false, edtavId_Internalname, StringUtil.LTrimStr( (decimal)(AV21Id), 12, 0));
            AV17GUID = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV7Applications.Item(AV20I_LoadCount_Grid)).gxTpr_Guid;
            AssignAttri("", false, edtavGuid_Internalname, AV17GUID);
            edtavName_Link = formatLink("k2bfsg.entryapplication.aspx", new object[] {UrlEncode(StringUtil.RTrim("DSP")),UrlEncode(StringUtil.LTrimStr(AV21Id,12,0))}, new string[] {"Mode","Id"}) ;
            AssignProp("", false, edtavName_Internalname, "Link", edtavName_Link, !bGXsfl_102_Refreshing);
         }
         else
         {
            AV10Exit_Grid = true;
      ...
      protected void S242( )
      {
         ...
         AV14GridState.gxTpr_Currentpage = AV8CurrentPage_Grid;
         ...
         AV15GridStateFilterValue.gxTpr_Value = AV12FilName;
         AV14GridState.gxTpr_Filtervalues.Add(AV15GridStateFilterValue, 0);
         AV15GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV15GridStateFilterValue.gxTpr_Filtername = "FilDescription";
         AV15GridStateFilterValue.gxTpr_Value = AV11FilDescription;
         AV14GridState.gxTpr_Filtervalues.Add(AV15GridStateFilterValue, 0);
      ...
      protected void S122( )
      {
         ...
         while ( AV47GXV2 <= AV14GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV12FilName = AV15GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV12FilName", AV12FilName);
            }
            else if ( StringUtil.StrCmp(AV15GridStateFilterValue.gxTpr_Filtername, "FilDescription") == 0 )
            {
               AV11FilDescription = AV15GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV11FilDescription", AV11FilDescription);
            }
         ...
         {
            AV8CurrentPage_Grid = AV14GridState.gxTpr_Currentpage;
            AssignAttri("", false, "AV8CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV8CurrentPage_Grid), 4, 0));
         }
      }
      ...
      protected void E173A2( )
      {
         ...
         if ( AV29RowsPerPage_Grid != AV30GridSettingsRowsPerPage_Grid )
         {
            AV29RowsPerPage_Grid = AV30GridSettingsRowsPerPage_Grid;
            AssignAttri("", false, "AV29RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV29RowsPerPage_Grid), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV44Pgmname,  "Grid",  AV29RowsPerPage_Grid) ;
            AV8CurrentPage_Grid = 1;
            AssignAttri("", false, "AV8CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV8CurrentPage_Grid), 4, 0));
         }
         gxgrGrid_refresh( AV31FilName_PreviousValue, AV32FilDescription_PreviousValue, AV12FilName, AV11FilDescription, AV44Pgmname, AV8CurrentPage_Grid, AV18HasNextPage_Grid, AV38GridConfiguration, AV41ClassCollection_Grid, AV29RowsPerPage_Grid, AV20I_LoadCount_Grid, AV42FreezeColumnTitles_Grid) ;
      ...
      protected void S132( )
      {
         ...
         AV34K2BFilterValuesSDT_WebForm = new GXBaseCollection<SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem>( context, "K2BFilterValuesSDTItem", "test");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12FilName)) )
         {
            AV35K2BFilterValuesSDTItem_WebForm = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Name = "FilName";
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Description = edtavFilname_Caption;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Canbedeleted = true;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Type = "Standard";
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Value = AV12FilName;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = StringUtil.RTrim( context.localUtil.Format( AV12FilName, ""));
            AV34K2BFilterValuesSDT_WebForm.Add(AV35K2BFilterValuesSDTItem_WebForm, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11FilDescription)) )
         {
            AV35K2BFilterValuesSDTItem_WebForm = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Name = "FilDescription";
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Description = edtavFildescription_Caption;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Canbedeleted = true;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Type = "Standard";
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Value = AV11FilDescription;
            AV35K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = StringUtil.RTrim( context.localUtil.Format( AV11FilDescription, ""));
            AV34K2BFilterValuesSDT_WebForm.Add(AV35K2BFilterValuesSDTItem_WebForm, 0);
         }
         ...
         if ( AV34K2BFilterValuesSDT_WebForm.Count > 0 )
         {
            GXt_objcol_SdtK2BValueDescriptionCollection_Item3 = AV39FilterTagsCollection_Grid;
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV44Pgmname,  "Filters",  AV34K2BFilterValuesSDT_WebForm, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void wb_table1_110_3A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWApplication.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_110_3A2e( true) ;
         }
         else
         {
            wb_table1_110_3A2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221352175", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/wwapplication.js", "?202431221352181", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void SubsflControlProps_1022( )
      {
         ...
         edtavId_Internalname = "vID_"+sGXsfl_102_idx;
         edtavGuid_Internalname = "vGUID_"+sGXsfl_102_idx;
      ...
      protected void SubsflControlProps_fel_1022( )
      {
         ...
         edtavId_Internalname = "vID_"+sGXsfl_102_fel_idx;
         edtavGuid_Internalname = "vGUID_"+sGXsfl_102_fel_idx;
      ...
      protected void sendrow_1022( )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavName_Internalname,StringUtil.RTrim( AV23Name),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavName_Enabled!=0)&&(edtavName_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,103);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtavName_Link,(string)"",(string)"",(string)"",(string)edtavName_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn",(string)"",(short)-1,(int)edtavName_Enabled,(short)0,(string)"text",(string)"",(short)570,(string)"px",(short)17,(string)"px",(short)254,(short)0,(short)0,(short)102,(short)0,(short)-1,(short)-1,(bool)true,(string)"GeneXusSecurityCommon\\GAMDescriptionLong",(string)"start",(bool)true,(string)""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 104,'',false,'"+sGXsfl_102_idx+"',102)\"" : " ");
         ROClassString = "Attribute_Grid";
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV21Id), 12, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtavId_Enabled!=0) ? context.localUtil.Format( (decimal)(AV21Id), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV21Id), "ZZZZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,104);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(int)edtavId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)102,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMKeyNumLong",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavGuid_Enabled!=0)&&(edtavGuid_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 105,'',false,'"+sGXsfl_102_idx+"',102)\"" : " ");
         ROClassString = "Attribute_Grid";
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavGuid_Internalname,StringUtil.RTrim( AV17GUID),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavGuid_Enabled!=0)&&(edtavGuid_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,105);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavGuid_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(int)edtavGuid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)102,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMGUID",(string)"start",(bool)true,(string)""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         StyleString = "";
         AV36Update_Action_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV36Update_Action))&&String.IsNullOrEmpty(StringUtil.RTrim( AV45Update_action_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV36Update_Action)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update_Action)) ? AV45Update_action_GXI : context.PathToRelativeUrl( AV36Update_Action));
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdate_action_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"Update",(string)edtavUpdate_action_Tooltiptext,(short)0,(short)1,(short)20,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)7,(string)edtavUpdate_action_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+"e223a2_client"+"'",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV36Update_Action_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl102( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV17GUID)));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavGuid_Enabled), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( AV36Update_Action));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavFildescription_Internalname = "vFILDESCRIPTION";
         divTable_container_fildescription_Internalname = "TABLE_CONTAINER_FILDESCRIPTION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavFildescription_Jsonclick = "";
         edtavFildescription_Enabled = 1;
         edtavFilname_Jsonclick = "";
         edtavFilname_Enabled = 1;
         divLayoutdefined_filtercollapsiblesection_onlydetailed_grid_Visible = 1;
         edtavFildescription_Caption = context.GetMessage( "K2BT_GAM_Description", "");
         edtavFilname_Caption = context.GetMessage( "K2BT_GAM_Name", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "K2BT_GAM_Applications", "");
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_NEW'","{handler:'E133A1',iparms:[]");
         setEventMetadata("'E_NEW'",",oparms:[]}");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'","{handler:'E143A1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRID)'","{handler:'E163A1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGNEXT(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_UPDATE'","{handler:'E223A2',iparms:[{av:'AV21Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("'E_UPDATE'",",oparms:[{av:'AV21Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("'E_DELETE'","{handler:'E233A2',iparms:[{av:'AV21Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("'E_DELETE'",",oparms:[{av:'AV21Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E203A2',iparms:[{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'tblI_noresultsfoundtablename_grid_Visible',ctrl:'I_NORESULTSFOUNDTABLENAME_GRID',prop:'Visible'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV36Update_Action',fld:'vUPDATE_ACTION',pic:''},{av:'edtavUpdate_action_Tooltiptext',ctrl:'vUPDATE_ACTION',prop:'Tooltiptext'},{av:'AV37Delete_Action',fld:'vDELETE_ACTION',pic:''},{av:'edtavDelete_action_Tooltiptext',ctrl:'vDELETE_ACTION',prop:'Tooltiptext'},{av:'AV23Name',fld:'vNAME',pic:''},{av:'AV21Id',fld:'vID',pic:'ZZZZZZZZZZZ9'},{av:'AV17GUID',fld:'vGUID',pic:''},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'}]}");
         setEventMetadata("'PAGINGFIRST(GRID)'","{handler:'E153A1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGFIRST(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'","{handler:'E123A1',iparms:[{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'}]");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'",",oparms:[{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV30GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'}]}");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'","{handler:'E173A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV20I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''},{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV30GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'}]");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'",",oparms:[{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV29RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV31FilName_PreviousValue',fld:'vFILNAME_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV32FilDescription_PreviousValue',fld:'vFILDESCRIPTION_PREVIOUSVALUE',pic:'',hsh:true},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{ctrl:'NEW',prop:'Visible'},{av:'AV42FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E213A2',iparms:[{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'edtavFilname_Caption',ctrl:'vFILNAME',prop:'Caption'},{av:'AV11FilDescription',fld:'vFILDESCRIPTION',pic:''},{av:'edtavFildescription_Caption',ctrl:'vFILDESCRIPTION',prop:'Caption'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV18HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV38GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV41ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERTOGGLE_ONLYDETAILED_GRID.CLICK","{handler:'E113A1',iparms:[{av:'divLayoutdefined_filtercollapsiblesection_onlydetailed_grid_Visible',ctrl:'LAYOUTDEFINED_FILTERCOLLAPSIBLESECTION_ONLYDETAILED_GRID',prop:'Visible'}]");
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV31FilName_PreviousValue = "";
         AV32FilDescription_PreviousValue = "";
         AV12FilName = "";
         AV11FilDescription = "";
         AV44Pgmname = "";
         ...
         AV13Filter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter(context);
         AV7Applications = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
      ...
      private short AV30GridSettingsRowsPerPage_Grid ;
      ...
      private int edtavFildescription_Enabled ;
      ...
      private string edtavFildescription_Caption ;
      private string gxfirstwebparm ;
      private string gxfirstwebparm_bkp ;
      private string sGXsfl_102_idx="0001" ;
      private string AV31FilName_PreviousValue ;
      private string AV32FilDescription_PreviousValue ;
      private string AV12FilName ;
      private string AV11FilDescription ;
      ...
      private string divTable_container_fildescription_Internalname ;
      private string edtavFildescription_Internalname ;
      private string edtavFildescription_Jsonclick ;
      ...
      private bool AV33RowsPerPageLoaded_Grid ;
      private bool gx_refresh_fired ;
      private bool AV24Reload_Grid ;
      private bool AV10Exit_Grid ;
      private bool AV36Update_Action_IsBlob ;
      ...
      private string AV36Update_Action ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV7Applications ;
      ...
      private GXBaseCollection<SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem> AV34K2BFilterValuesSDT_WebForm ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV13Filter ;
      ...
      private SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem AV35K2BFilterValuesSDTItem_WebForm ;
