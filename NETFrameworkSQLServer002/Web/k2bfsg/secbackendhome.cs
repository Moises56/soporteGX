...
namespace GeneXus.Programs.k2bfsg {
   public class secbackendhome : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return context.GetMessage( "K2BT_GAM_SecurityBackendHome", "") ;
      }
      ...
      protected void WB360( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "Security Configuration", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
      ...
      protected void START362( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_SecurityBackendHome", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         ...
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV5ActivityList.Item(1)).gxTpr_Isauthorized )
         {
            ...
            bttButtonusers_Caption = context.GetMessage( "K2BT_GAM_Notauthorized", "");
         ...
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV5ActivityList.Item(2)).gxTpr_Isauthorized )
         {
            ...
            bttButtonroles_Caption = context.GetMessage( "K2BT_GAM_Notauthorized", "");
         ...
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV5ActivityList.Item(3)).gxTpr_Isauthorized )
         {
            ...
            bttButtonapplications_Caption = context.GetMessage( "K2BT_GAM_Notauthorized", "");
         ...
         {
            bttButtonauthtypes_Caption = context.GetMessage( "K2BT_GAM_Notauthorized", "");
      ...
      protected void wb_table6_84_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockadvanced_Internalname, context.GetMessage( "K2BT_GAM_Advanced", ""), "", "", lblTextblockadvanced_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksecuritypolicies_Internalname, context.GetMessage( "K2BT_GAM_SecurityPolicies", ""), "", "", lblTextblocksecuritypolicies_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13361_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockrepositoryconfigurations_Internalname, context.GetMessage( "K2BT_GAM_RepositoryConfigurations", ""), "", "", lblTextblockrepositoryconfigurations_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14361_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockconnections_Internalname, context.GetMessage( "K2BT_GAM_Connections", ""), "", "", lblTextblockconnections_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15361_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void wb_table5_70_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockauthenticationtypes_Internalname, context.GetMessage( "K2BT_GAM_AuthenticationTypes", ""), "", "", lblTextblockauthenticationtypes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, context.GetMessage( "K2BT_GAM_AuthenticationTypesOptionSummary", ""), "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardDescription", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButtonauthtypes_Internalname, "", bttButtonauthtypes_Caption, bttButtonauthtypes_Jsonclick, 7, context.GetMessage( "K2BT_GAM_AuthenticationTypes", ""), "", StyleString, ClassString, 1, bttButtonauthtypes_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"e16361_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void wb_table4_56_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMenus1_Internalname, context.GetMessage( "K2BT_GAM_Menus", ""), "", "", lblMenus1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMenudescription_Internalname, context.GetMessage( "K2BT_GAM_MenusOptionSummary", ""), "", "", lblMenudescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttMenus_Internalname, "", context.GetMessage( "K2BT_GAM_Menus", ""), bttMenus_Jsonclick, 7, context.GetMessage( "K2BT_GAM_Menus", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e17361_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void wb_table3_41_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockapplications_Internalname, context.GetMessage( "K2BT_GAM_Applications", ""), "", "", lblTextblockapplications_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, context.GetMessage( "K2BT_GAM_ApplicationsOptionSummary", ""), "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardDescription", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButtonapplications_Internalname, "", bttButtonapplications_Caption, bttButtonapplications_Jsonclick, 7, context.GetMessage( "K2BT_GAM_Applications", ""), "", StyleString, ClassString, 1, bttButtonapplications_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"e18361_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void wb_table2_27_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockroles_Internalname, context.GetMessage( "K2BT_GAM_Roles", ""), "", "", lblTextblockroles_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, context.GetMessage( "K2BT_GAM_RolesOptionSummary", ""), "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardDescription", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButtonroles_Internalname, "", bttButtonroles_Caption, bttButtonroles_Jsonclick, 7, context.GetMessage( "K2BT_GAM_Roles", ""), "", StyleString, ClassString, 1, bttButtonroles_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"e19361_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void wb_table1_13_362( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusers_Internalname, context.GetMessage( "K2BT_GAM_Users", ""), "", "", lblTextblockusers_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardTitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, context.GetMessage( "K2BT_GAM_UsersOptionSummary", ""), "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BFSGTextBlock_DashboardDescription", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButtonusers_Internalname, "", bttButtonusers_Caption, bttButtonusers_Jsonclick, 7, context.GetMessage( "K2BT_GAM_Users", ""), "", StyleString, ClassString, 1, bttButtonusers_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"e20361_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\SecBackendHome.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221343976", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/secbackendhome.js", "?202431221343976", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         bttButtonauthtypes_Caption = context.GetMessage( "K2BT_GAM_AuthenticationTypes", "");
         bttButtonapplications_Class = "K2BToolsButton_MainAction";
         bttButtonapplications_Caption = context.GetMessage( "K2BT_GAM_Applications", "");
         bttButtonroles_Caption = context.GetMessage( "K2BT_GAM_Roles", "");
         bttButtonroles_Class = "K2BToolsButton_MainAction";
         bttButtonusers_Class = "K2BToolsButton_MainAction";
         bttButtonusers_Caption = context.GetMessage( "K2BT_GAM_Users", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "K2BT_GAM_SecurityBackendHome", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
