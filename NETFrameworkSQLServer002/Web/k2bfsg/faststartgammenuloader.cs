...
namespace GeneXus.Programs.k2bfsg {
   public class faststartgammenuloader : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         GXt_boolean1 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.SecBackendHome",  context.GetMessage( "Home", ""),  "",  "fa fa-home",  formatLink("k2bfsg.secbackendhome.aspx") ,  1,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean1, ref  AV10MenuLevel0) ;
         GXt_boolean2 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWUser",  context.GetMessage( "K2BT_GAM_Users", ""),  "",  "fa fa-user",  formatLink("k2bfsg.wwuser.aspx") ,  2,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean2, ref  AV10MenuLevel0) ;
         GXt_boolean3 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWRole",  context.GetMessage( "K2BT_GAM_Roles", ""),  "",  "fa fa-users",  formatLink("k2bfsg.wwrole.aspx") ,  3,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean3, ref  AV10MenuLevel0) ;
         GXt_boolean4 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWMenu",  context.GetMessage( "K2BT_GAM_Menus", ""),  "",  "fa fa-bars",  formatLink("k2bfsg.wwmenu.aspx") ,  4,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean4, ref  AV10MenuLevel0) ;
         GXt_boolean5 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWApplication",  context.GetMessage( "K2BT_GAM_Applications", ""),  "",  "fa fa-archive",  formatLink("k2bfsg.wwapplication.aspx") ,  5,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean5, ref  AV10MenuLevel0) ;
      ...
      protected void S111( )
      {
         ...
         AV12MenuLevel1.gxTpr_Title = context.GetMessage( "Advanced", "");
         GXt_boolean5 = true;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWAuthType",  context.GetMessage( "K2BT_GAM_AuthenticationTypes", ""),  "",  "fa fa-key",  formatLink("k2bfsg.wwauthtype.aspx") ,  7,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean4, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem7) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWConnections",  context.GetMessage( "K2BT_GAM_RepositoryConnections", ""),  "",  "fa fa-plug",  formatLink("k2bfsg.wwconnections.aspx") ,  8,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean3, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem8) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWSecurityPolicy",  context.GetMessage( "K2BT_GAM_SecurityPolicies", ""),  "",  "fa fa-file-text-o",  formatLink("k2bfsg.wwsecuritypolicy.aspx") ,  9,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean2, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem9) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.ChangeRepository",  context.GetMessage( "Change Repository", ""),  "",  "",  formatLink("k2bfsg.changerepository.aspx") ,  10,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean1, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem10) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWRepositories",  context.GetMessage( "K2BT_GAM_Repositories", ""),  "",  "",  formatLink("k2bfsg.wwrepositories.aspx") ,  11,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean11, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem12) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWEventSubscription",  context.GetMessage( "K2BT_GAM_EventSubscriptions", ""),  "",  "",  formatLink("k2bfsg.wweventsubscription.aspx") ,  12,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean13, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem14) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.GAMConfiguration",  context.GetMessage( "K2BT_GAM_GAMConfiguration", ""),  "",  "",  formatLink("k2bfsg.gamconfiguration.aspx") ,  13,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean15, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem16) ;
