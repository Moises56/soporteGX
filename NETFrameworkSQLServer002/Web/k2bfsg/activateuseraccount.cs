   ...
   public class activateuseraccount : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB4K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGotologin_Internalname, "", context.GetMessage( "K2BT_GAM_GoToLogin", ""), bttGotologin_Jsonclick, 7, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e114k1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\ActivateUserAccount.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S142( )
      {
         ...
         if ( AV20isOK )
         {
            lblTbmsg_Caption = context.GetMessage( "K2BT_GAM_YourUserAccountWasActivatedSuccessfully", "")+StringUtil.NewLine( )+context.GetMessage( "K2BT_GAM_YouMustGoToTheLoginPageToEnterTheApplication", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221391478", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/activateuseraccount.js", "?202431221391482", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
