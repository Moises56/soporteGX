...
namespace GeneXus.Programs.k2bfsg {
   public class changepassword : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public changepassword( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2bfsg.changepassword.aspx") +"\">") ;
      ...
      {
         return formatLink("k2bfsg.changepassword.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "K2BFSG.ChangePassword" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "K2BT_GAM_ChangePassword", "") ;
      }
      ...
      protected void WB4E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_ChangePassword", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\ChangePassword.htm");
            ...
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, context.GetMessage( "K2BT_GAM_User", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 33,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV8UserName, StringUtil.RTrim( context.localUtil.Format( AV8UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsername_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "start", true, "", "HLP_K2BFSG\\ChangePassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV9UserPassword), StringUtil.RTrim( context.localUtil.Format( AV9UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUserpassword_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUserpassword_Enabled, 1, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_K2BFSG\\ChangePassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUserpasswordnew_Internalname, StringUtil.RTrim( AV10UserPasswordNew), StringUtil.RTrim( context.localUtil.Format( AV10UserPasswordNew, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUserpasswordnew_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUserpasswordnew_Enabled, 1, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_K2BFSG\\ChangePassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUserpasswordnewconf_Internalname, StringUtil.RTrim( AV11UserPasswordNewConf), StringUtil.RTrim( context.localUtil.Format( AV11UserPasswordNewConf, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUserpasswordnewconf_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavUserpasswordnewconf_Enabled, 1, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_K2BFSG\\ChangePassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttConfirm_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttConfirm_Jsonclick, 5, "", "", StyleString, ClassString, bttConfirm_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\ChangePassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START4E2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_ChangePassword", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void S152( )
      {
         ...
         while ( AV19GXV1 <= AV7Errors.Count )
         {
            ...
            new k2btoolsmsg(context ).execute(  StringUtil.Format( "%1 (GAM%2)", AV6Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV6Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""),  2) ;
      ...
      protected void S142( )
      {
         ...
         if ( StringUtil.StrCmp(AV10UserPasswordNew, AV11UserPasswordNewConf) == 0 )
         {
            ...
            if ( AV5ChangePwdOK )
            {
               context.CommitDataStores("k2bfsg.changepassword",pr_default);
               ...
               new k2btoolsmsg(context ).execute(  context.GetMessage( "K2BT_GAM_Passwordwaschangedsuccessfully", ""),  3) ;
            }
            else
            {
         ...
         {
            new k2btoolsmsg(context ).execute(  context.GetMessage( "K2BT_GAM_PasswordsDoNotMatch", ""),  2) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221385939", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/changepassword.js", "?202431221385941", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "K2BT_GAM_ChangePassword", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH",",oparms:[{av:'AV8UserName',fld:'vUSERNAME',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E134E2',iparms:[{av:'AV10UserPasswordNew',fld:'vUSERPASSWORDNEW',pic:''},{av:'AV11UserPasswordNewConf',fld:'vUSERPASSWORDNEWCONF',pic:''},{av:'AV9UserPassword',fld:'vUSERPASSWORD',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.changepassword__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.changepassword__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
   ...
   public class changepassword__gam : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class changepassword__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
