...
namespace GeneXus.Programs.k2bfsg {
   public class entryauthenticationtype : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return context.GetMessage( "K2BT_GAM_EntryAuthenticationType", "") ;
      }
      ...
      protected void WB3Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_AuthenticationType", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryAuthenticationType.htm");
            ...
            GxWebStd.gx_label_element( context, cmbavTypeid_Internalname, context.GetMessage( "K2BT_GAM_TypeId", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
      ...
      protected void START3Q2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_EntryAuthenticationType", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            while ( AV28GXV2 <= AV27GXV1.Count )
            {
               ...
               {
                  cmbavTypeid.addItem(AV25AuthenticationType, context.GetMessage( GeneXus.Programs.genexussecuritycommon.gxdomaingamauthenticationtypes.getDescription(context,AV25AuthenticationType), ""), 0);
               }
         ...
         {
            cmbavTypeid.addItem(AV22TypeIdDsp, context.GetMessage( GeneXus.Programs.genexussecuritycommon.gxdomaingamauthenticationtypes.getDescription(context,AV22TypeIdDsp), ""), 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221371872", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/entryauthenticationtype.js", "?202431221371873", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "K2BT_GAM_EntryAuthenticationType", "");
