...
namespace GeneXus.Programs.k2bfsg {
   public class emailsent : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( context.GetMessage( "K2BT_GAM_EmailSent", "")) ;
      ...
      {
         return context.GetMessage( "K2BT_GAM_EmailSent", "") ;
      }
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMessage_Internalname, context.GetMessage( "K2BT_GAM_AnEmailWasSent", ""), "", "", lblMessage_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EmailSent.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void START4F2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_EmailSent", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E134F2( )
      {
         ...
         S112 ();
         if (returnInSub) return;
         AV8GoToLogin_Action = context.GetMessage( "K2BT_GAM_GoToLogin", "");
      ...
      protected void S142( )
      {
         ...
         {
            lblWaittime_Caption = StringUtil.Format( context.GetMessage( "K2BT_GAM_PleaseWaitForNewRecoveryEmail", ""), StringUtil.LTrimStr( (decimal)(AV12MinMinutesBetweenEmails), 4, 0), "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243122139178", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/emailsent.js", "?20243122139178", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Attributes_Title = context.GetMessage( "K2BT_GAM_EmailSent", "");
