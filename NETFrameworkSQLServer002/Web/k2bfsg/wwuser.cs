...
namespace GeneXus.Programs.k2bfsg {
   public class wwuser : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vANONYMOUSUSERGUID", StringUtil.RTrim( AV7AnonymousUserGUID));
         GxWebStd.gx_hidden_field( context, "gxhash_vANONYMOUSUSERGUID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV7AnonymousUserGUID, "")), context));
         GxWebStd.gx_hidden_field( context, "vROWSPERPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV54RowsPerPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11CurrentPage_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vI_LOADCOUNT_GRID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV28I_LoadCount_Grid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vI_LOADCOUNT_GRID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV28I_LoadCount_Grid), "ZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, "vHASNEXTPAGE_GRID", AV26HasNextPage_Grid);
         GxWebStd.gx_hidden_field( context, "gxhash_vHASNEXTPAGE_GRID", GetSecureSignedToken( "", AV26HasNextPage_Grid, context));
      ...
      {
         return context.GetMessage( "K2BT_GAM_Users", "") ;
      }
      ...
      protected void WB370( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_Users", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUser.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLayoutdefined_k2bt_filtercaption_grid_Internalname, context.GetMessage( "K2BT_Filters", ""), "", "", lblLayoutdefined_k2bt_filtercaption_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_FilterToggleText", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            ...
            GxWebStd.gx_label_element( context, edtavFilname_Internalname, context.GetMessage( "K2BT_GAM_User", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFilnames_Internalname, context.GetMessage( "K2BT_GAM_Name", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'',false,'" + sGXsfl_147_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFilnames_Internalname, StringUtil.RTrim( AV19FilNames), StringUtil.RTrim( context.localUtil.Format( AV19FilNames, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "K2BT_GAM_NameLastName", ""), edtavFilnames_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavFilnames_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionShort", "start", true, "", "HLP_K2BFSG\\WWUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFilemail_Internalname, context.GetMessage( "K2BT_GAM_Email", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavFilauttype_Internalname, context.GetMessage( "K2BT_GAM_AuthenticationType", ""), "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsvisible_authenticationtypename_Internalname, context.GetMessage( "K2BT_GAM_Authentication", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsvisible_name_Internalname, context.GetMessage( "K2BT_GAM_Name", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIsvisible_name_Internalname, StringUtil.BoolToStr( AV46IsVisible_Name), "", context.GetMessage( "K2BT_GAM_Name", ""), 1, chkavIsvisible_name.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(101, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,101);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsvisible_firstname_Internalname, context.GetMessage( "K2BT_GAM_FirstName", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIsvisible_firstname_Internalname, StringUtil.BoolToStr( AV47IsVisible_FirstName), "", context.GetMessage( "K2BT_GAM_FirstName", ""), 1, chkavIsvisible_firstname.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(107, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,107);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsvisible_lastname_Internalname, context.GetMessage( "K2BT_GAM_LastName", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIsvisible_lastname_Internalname, StringUtil.BoolToStr( AV48IsVisible_LastName), "", context.GetMessage( "K2BT_GAM_LastName", ""), 1, chkavIsvisible_lastname.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(113, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,113);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsvisible_email_Internalname, context.GetMessage( "K2BT_GAM_Email", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIsvisible_email_Internalname, StringUtil.BoolToStr( AV49IsVisible_Email), "", context.GetMessage( "K2BT_GAM_Email", ""), 1, chkavIsvisible_email.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(119, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,119);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGridsettings_savegrid_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(147), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GridSettingsApply", ""), bttGridsettings_savegrid_Jsonclick, 5, context.GetMessage( "K2BT_GridSettingsApply", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS(GRID)\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\WWUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAdd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(147), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_InsertAction", ""), bttAdd_Jsonclick, 7, "", "", StyleString, ClassString, bttAdd_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13371_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\WWUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START372( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_Users", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP370( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11CurrentPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCURRENTPAGE_GRID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV54RowsPerPage_Grid = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vROWSPERPAGE_GRID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S262( )
      {
         ...
         cmbavFilauttype.addItem("", context.GetMessage( "GX_AllItems", ""), 0);
      ...
      private void E19372( )
      {
         ...
         while ( true )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Trim( AV39UserId), StringUtil.Trim( AV7AnonymousUserGUID)) != 0 ) && ! AV29IsAutoRegisterUser )
            {
               ...
               edtavPassword_action_Tooltiptext = context.GetMessage( "K2BT_GAM_ChangePassword", "");
            }
            else
            {
               edtavPassword_action_gximage = "K2BT_Password";
      ...
      protected void S212( )
      {
         ...
         AV44GridColumn.gxTpr_Columntitle = context.GetMessage( "K2BT_GAM_Authentication", "");
         AV44GridColumn.gxTpr_Showattribute = true;
         AV43GridColumns.Add(AV44GridColumn, 0);
         AV44GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV44GridColumn.gxTpr_Attributename = "&Name";
         AV44GridColumn.gxTpr_Columntitle = context.GetMessage( "K2BT_GAM_Name", "");
         AV44GridColumn.gxTpr_Showattribute = true;
         AV43GridColumns.Add(AV44GridColumn, 0);
         AV44GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV44GridColumn.gxTpr_Attributename = "&FirstName";
         AV44GridColumn.gxTpr_Columntitle = context.GetMessage( "K2BT_GAM_FirstName", "");
         AV44GridColumn.gxTpr_Showattribute = true;
         AV43GridColumns.Add(AV44GridColumn, 0);
         AV44GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV44GridColumn.gxTpr_Attributename = "&LastName";
         AV44GridColumn.gxTpr_Columntitle = context.GetMessage( "K2BT_GAM_LastName", "");
         AV44GridColumn.gxTpr_Showattribute = true;
         AV43GridColumns.Add(AV44GridColumn, 0);
         AV44GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV44GridColumn.gxTpr_Attributename = "&Email";
         AV44GridColumn.gxTpr_Columntitle = context.GetMessage( "K2BT_GAM_Email", "");
         AV44GridColumn.gxTpr_Showattribute = true;
         AV43GridColumns.Add(AV44GridColumn, 0);
      ...
      protected void wb_table1_160_372( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWUser.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221361856", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/wwuser.js", "?202431221361863", false, true);
            context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void StartGridControl147( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_IsAutoRegisterUser", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         chkavIsvisible_email.Caption = context.GetMessage( "K2BT_GAM_Email", "");
         chkavIsvisible_lastname.Caption = context.GetMessage( "K2BT_GAM_LastName", "");
         chkavIsvisible_firstname.Caption = context.GetMessage( "K2BT_GAM_FirstName", "");
         chkavIsvisible_name.Caption = context.GetMessage( "K2BT_GAM_Name", "");
         chkavIsvisible_authenticationtypename.Caption = context.GetMessage( "K2BT_GAM_Authentication", "");
         ...
         cmbavFilauttype.Caption = context.GetMessage( "K2BT_GAM_AuthenticationType", "");
         edtavFilemail_Caption = context.GetMessage( "K2BT_GAM_Email", "");
         edtavFilnames_Caption = context.GetMessage( "K2BT_GAM_Name", "");
         edtavFilname_Caption = context.GetMessage( "K2BT_GAM_User", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "K2BT_GAM_Users", "");
