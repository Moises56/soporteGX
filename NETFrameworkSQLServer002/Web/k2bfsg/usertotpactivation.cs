...
namespace GeneXus.Programs.k2bfsg {
   public class usertotpactivation : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return context.GetMessage( "User Totp Activation", "") ;
      }
      ...
      protected void WB430( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, context.GetMessage( "K2BT_GAM_Name", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSecretkey_Internalname, context.GetMessage( "K2BT_GAM_SecretKey", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", context.GetMessage( "K2BT_GAM_ScanQRImage", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavTotpcode_Internalname, context.GetMessage( "K2BT_GAM_TotpCode", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnable_Internalname, "", context.GetMessage( "K2BT_GAM_EnableAuthenticator", ""), bttEnable_Jsonclick, 5, "", "", StyleString, ClassString, bttEnable_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_ENABLE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\UserTotpActivation.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "K2BToolsTableCell_ActionContainer", "start", "top", "", "flex-grow:1;", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBack_Internalname, "", context.GetMessage( "K2BT_GAM_BackAction", ""), bttBack_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_BACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\UserTotpActivation.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START432( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "User Totp Activation", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void S142( )
      {
         ...
         if ( AV11GAMUSer.validatetotpcode(AV16TotpCode, out  AV10GAMErrorCollection) )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "K2BT_GAM_EnableAuthenticatorSuccessMsg", ""));
               bttEnable_Visible = 0;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221373258", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/usertotpactivation.js", "?202431221373259", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Attributes_Title = context.GetMessage( "K2BT_GAM_EnableAuthenticator", "");
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = context.GetMessage( "User Totp Activation", "");
