   ...
   public class sendrecoveryemail : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( AV11Errors.Count == 0 )
         {
            ...
            AV12GAMUserAttribute.gxTpr_Value = context.localUtil.TToC( AV13LastEmailSent, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " ");
