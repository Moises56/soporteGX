...
namespace GeneXus.Programs.k2bfsg {
   public class wwrole : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return context.GetMessage( "K2BT_GAM_Roles", "") ;
      }
      ...
      protected void WB380( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( " Roles", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWRole.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWRole.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAdd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(83), 2, 0)+","+"null"+");", context.GetMessage( "K2BT_InsertAction", ""), bttAdd_Jsonclick, 7, "", "", StyleString, ClassString, bttAdd_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12381_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\WWRole.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START382( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_Roles", ""), 0) ;
         context.wjLoc = "";
      ...
      private void E19382( )
      {
         ...
         while ( true )
         {
            ...
            S192 ();
            if (returnInSub) return;
            AV7Copy_Action = context.GetMessage( "K2BT_GAM_Copy", "");
            AssignAttri("", false, edtavCopy_action_Internalname, AV7Copy_Action);
      ...
      protected void S252( )
      {
         ...
         if ( AV36IsOK )
         {
            ...
            GX_msglist.addItem(StringUtil.Format( context.GetMessage( "K2BT_GAM_successfullycopied", ""), AV27Role.gxTpr_Name, "", "", "", "", "", "", "", ""));
            gxgrGrid_refresh( AV41GenericFilter_PreviousValue_Grid, AV43Pgmname, AV8CurrentPage_Grid, AV13GenericFilter_Grid, AV18HasNextPage_Grid, AV38GridConfiguration, AV39ClassCollection_Grid, AV29RowsPerPage_Grid, AV20I_LoadCount_Grid, AV40FreezeColumnTitles_Grid) ;
         }
         else
         {
      ...
      protected void wb_table1_91_382( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWRole.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243122135662", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/wwrole.js", "?20243122135668", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "K2BT_GAM_Roles", "");
