...
namespace GeneXus.Programs.k2bfsg {
   public class entryconnection : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_GRIDWWSYSCONNS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36CurrentPage_GridWWSysConns), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "K2BT_GAM_EntryConnection", "") ;
      }
      ...
      protected void WB3V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_GAM_RepositoryConnection", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryConnection.htm");
            ...
            GxWebStd.gx_label_element( context, edtavConnectionname_Internalname, context.GetMessage( "K2BT_GAM_ConnectionName", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, context.GetMessage( "K2BT_GAM_UserPassword", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_var_challengeexpire_Internalname, context.GetMessage( "K2BT_GAM_Connectionchallengeexpire", ""), "", "", lblTextblock_var_challengeexpire_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryConnection.htm");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavChallengeexpire_Internalname, context.GetMessage( "K2BT_GAM_Connectionchallengeexpire", ""), "gx-form-item Attribute_TrnLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'',false,'" + sGXsfl_111_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavChallengeexpire_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20ChallengeExpire), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV20ChallengeExpire), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,55);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavChallengeexpire_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavChallengeexpire_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "K2BNumber", "end", false, "", "HLP_K2BFSG\\EntryConnection.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblChallengeexpire_var_righttext_Internalname, context.GetMessage( "minutes (0 = never expires)", ""), "", "", lblChallengeexpire_var_righttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel RightLabel", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryConnection.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_var_encryptionkey_Internalname, context.GetMessage( "K2BT_GAM_Encryptionkey", ""), "", "", lblTextblock_var_encryptionkey_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryConnection.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavEncryptionkey_Internalname, context.GetMessage( "K2BT_GAM_Encryptionkey", ""), "gx-form-item Attribute_TrnLabel", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttCancel_Jsonclick, 7, "", "", StyleString, ClassString, bttCancel_Visible, bttCancel_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"e133v1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\EntryConnection.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavNewconnectionkey_Internalname, context.GetMessage( "K2BT_GAM_NewConnectionKey", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttUseautomatickey_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GAM_UseAutomaticKey", ""), bttUseautomatickey_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_USEAUTOMATICKEY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\EntryConnection.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 95,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttUsecurrentkey_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GAM_UseCurrentKey", ""), bttUsecurrentkey_Jsonclick, 5, "", "", StyleString, ClassString, bttUsecurrentkey_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_USECURRENTKEY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\EntryConnection.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 96,'',false,'',0)\"";
            ClassString = "K2BToolsButton_MainAction";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttSavekey_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", context.GetMessage( "K2BT_GAM_SaveKey", ""), bttSavekey_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_SAVEKEY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\EntryConnection.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_118_3V2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavConnectionfilexml_Internalname, context.GetMessage( "K2BT_GAM_Contentforconnectiongamfile", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFileconnectionkey_Internalname, context.GetMessage( "K2BT_GAM_FileConnectionKey", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void START3V2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2BT_GAM_EntryConnection", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP3V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavChallengeexpire_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavChallengeexpire_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999 )) ) )
            {
            ...
            {
               AV20ChallengeExpire = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavChallengeexpire_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV20ChallengeExpire", StringUtil.LTrimStr( (decimal)(AV20ChallengeExpire), 4, 0));
            }
      ...
      protected void S152( )
      {
         ...
         if ( ! ( ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 ) || ( StringUtil.StrCmp(Gx_mode, "XML") == 0 ) ) )
         {
            ...
            if ( AV5Connection.success() )
            {
               ...
               if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
               {
                  AV11Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Connectionwascreated", ""), AV17ConnectionName, "", "", "", "", "", "", "", "");
               }
               else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
               {
                  AV11Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Connectionwasupdated", ""), AV17ConnectionName, "", "", "", "", "", "", "", "");
               }
               else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
               {
                  AV11Message.gxTpr_Description = StringUtil.Format( context.GetMessage( "K2BT_GAM_Connectionwasdeleted", ""), AV17ConnectionName, "", "", "", "", "", "", "", "");
               }
      ...
      private void E223V2( )
      {
         ...
         while ( true )
         {
            ...
            S252 ();
            if (returnInSub) return;
            AV29File_Action = context.GetMessage( "K2BT_GAM_File", "");
            AssignAttri("", false, edtavFile_action_Internalname, AV29File_Action);
            AV30DeleteKey_Action = context.GetMessage( "K2BT_GAM_DeleteKey", "");
            AssignAttri("", false, edtavDeletekey_action_Internalname, AV30DeleteKey_Action);
      ...
      protected void S252( )
      {
         ...
         while ( AV44GXV3 <= AV43GXV2.Count )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Trim( AV35GAMSystemConnection.gxTpr_Key), StringUtil.Trim( AV32CurrentConnectionKey)) == 0 )
            {
               ...
               AV28isCurrentKey = context.GetMessage( "(current)", "");
               AssignAttri("", false, edtavIscurrentkey_Internalname, AV28isCurrentKey);
            }
            else
            {
      ...
      protected void wb_table1_118_3V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_gridwwsysconns_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_gridwwsysconns_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EntryConnection.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221381550", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/entryconnection.js", "?202431221381556", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void StartGridControl111( )
      {
         if ( GridwwsysconnsContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2BT_GAM_ConnectionKey", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "K2BT_GAM_IsCurrentKey", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Attributes_Title = context.GetMessage( "K2BT_GAM_Keys", "");
         ...
         Form.Caption = context.GetMessage( "K2BT_GAM_EntryConnection", "");
