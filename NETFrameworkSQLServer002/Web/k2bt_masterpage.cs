...
namespace GeneXus.Programs {
   public class k2bt_masterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME_MPAGE", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME_MPAGE", GetSecureSignedToken( "gxmpage_", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
      ...
      protected void RenderHtmlCloseForm2O2( )
      {
         ...
         context.AddJavascriptSource("k2bt_masterpage.js", "?20243122134715", false, true);
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgMenutoggle_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgMenutoggle_Jsonclick, "'"+""+"'"+",true,"+"'"+"e112o1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BT_MasterPage.htm");
            ...
            GxWebStd.gx_bitmap( context, imgApplicationicon_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgApplicationicon_Jsonclick, "'"+""+"'"+",true,"+"'"+"e122o1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavSearchcriteria_Internalname, StringUtil.RTrim( AV15SearchCriteria), StringUtil.RTrim( context.localUtil.Format( AV15SearchCriteria, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", context.GetMessage( "Search", ""), edtavSearchcriteria_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavSearchcriteria_Enabled, 0, "text", "", 26, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "K2BSearchCriteria", "start", true, "", "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Active images/pictures */
            ...
            GxWebStd.gx_bitmap( context, imgImage2_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage2_Jsonclick, "'"+""+"'"+",true,"+"'"+"e132o1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUserinitialstextblocksmall_Internalname, lblUserinitialstextblocksmall_Caption, "", "", lblUserinitialstextblocksmall_Jsonclick, "'"+""+"'"+",true,"+"'"+"e142o1_client"+"'", "", "K2BToolsTextblock_InitialsCircleSmall", 7, "", lblUserinitialstextblocksmall_Visible, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            ...
            StyleString = "";
            AV12UserAvatarSmall_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV12UserAvatarSmall))&&String.IsNullOrEmpty(StringUtil.RTrim( AV20Useravatarsmall_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV12UserAvatarSmall)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV12UserAvatarSmall)) ? AV20Useravatarsmall_GXI : context.PathToRelativeUrl( AV12UserAvatarSmall));
            GxWebStd.gx_bitmap( context, imgavUseravatarsmall_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgavUseravatarsmall_Visible, 1, "", "", 0, -1, 0, "", 0, "", 0, 0, 7, imgavUseravatarsmall_Jsonclick, "'"+""+"'"+",true,"+"'"+"e142o1_client"+"'", StyleString, ClassString, "", "", "", "", ""+TempTags, "", "", 1, AV12UserAvatarSmall_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsernametextblock_Internalname, lblUsernametextblock_Caption, "", "", lblUsernametextblock_Jsonclick, "'"+""+"'"+",true,"+"'"+"e142o1_client"+"'", "", "K2BToolsTextBlock_MyAccount", 7, "", 1, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            ...
            StyleString = "";
            AV11UserAvatar_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV11UserAvatar))&&String.IsNullOrEmpty(StringUtil.RTrim( AV21Useravatar_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV11UserAvatar)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV11UserAvatar)) ? AV21Useravatar_GXI : context.PathToRelativeUrl( AV11UserAvatar));
            GxWebStd.gx_bitmap( context, imgavUseravatar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgavUseravatar_Visible, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, AV11UserAvatar_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUserinitialstextblock_Internalname, lblUserinitialstextblock_Caption, "", "", lblUserinitialstextblock_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "K2BToolsTextblock_InitialsCircle", 0, "", lblUserinitialstextblock_Visible, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsername_Internalname, lblUsername_Caption, "", "", lblUsername_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "K2BToolsTextblock_UserName", 0, "", 1, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUseremail_Internalname, lblUseremail_Caption, "", "", lblUseremail_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "K2BToolsTextblock_UserEmail", 0, "", 1, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblChangepassword_Internalname, context.GetMessage( "K2BT_GAM_ChangePassword", ""), "", "", lblChangepassword_Jsonclick, "'"+""+"'"+",true,"+"'"+"e152o1_client"+"'", "", "K2BToolsTextBlock_ChangePassword", 7, "", 1, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignout_Internalname, context.GetMessage( "K2BT_GAM_SignOut", ""), "", "", lblSignout_Jsonclick, "'"+""+"'"+",true,"+"'"+"ESIGNOUT_MPAGE."+"'", "", "K2BToolsTextBlock_Logout", 5, "", 1, 1, 0, 0, "HLP_K2BT_MasterPage.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     else if ( nCmpId == 66 )
                     {
                        ...
                        WebComp_Footercomponent.componentprocess("MPW0066", "", sEvt);
                     }
                  }
      ...
      protected void RF2O2( )
      {
         ...
         if ( ShowMPWhenPopUp( ) || ! context.isPopUpObject( ) )
         {
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
            {
               ...
               WebComp_Footercomponent.componentprepare(new Object[] {(string)"MPW0066",(string)""});
      ...
      protected void STRUP2O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV15SearchCriteria = cgiGet( edtavSearchcriteria_Internalname);
            AssignAttri("", true, "AV15SearchCriteria", AV15SearchCriteria);
      ...
      protected void E162O2( )
      {
         ...
         AV18GXV2 = 1;
         GXt_objcol_SdtK2BAttributeValue_Item1 = AV17GXV1;
         new GeneXus.Programs.k2btools.getdesignsystemoptions(context ).execute( out  GXt_objcol_SdtK2BAttributeValue_Item1) ;
         AV17GXV1 = GXt_objcol_SdtK2BAttributeValue_Item1;
         while ( AV18GXV2 <= AV17GXV1.Count )
         {
            AV5DesignSystemOption = ((SdtK2BAttributeValue_Item)AV17GXV1.Item(AV18GXV2));
         ...
         GXt_objcol_SdtSearchableTransactions_SearchableTransactionsItem3 = AV14SearchableTransactions;
         new k2bgetsearchableentities(context ).execute( out  GXt_objcol_SdtSearchableTransactions_SearchableTransactionsItem3) ;
         AV14SearchableTransactions = GXt_objcol_SdtSearchableTransactions_SearchableTransactionsItem3;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "",  "",  "None",  "K2BToolsSearchResult",  AV19Pgmname) && ( AV14SearchableTransactions.Count > 0 ) )
         {
            GXt_char4 = AV16SearchCriteriaSession;
            new k2bsessionget(context ).execute(  AV19Pgmname+"-SearchCriteria", out  GXt_char4) ;
            AV16SearchCriteriaSession = GXt_char4;
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16SearchCriteriaSession)) )
            {
               AV15SearchCriteria = AV16SearchCriteriaSession;
               AssignAttri("", true, "AV15SearchCriteria", AV15SearchCriteria);
            }
         }
         else
         ...
         AssignProp("", true, imgavUseravatar_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV11UserAvatar)) ? AV21Useravatar_GXI : context.convertURL( context.PathToRelativeUrl( AV11UserAvatar))), true);
         ...
         AssignProp("", true, imgavUseravatarsmall_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV12UserAvatarSmall)) ? AV20Useravatarsmall_GXI : context.convertURL( context.PathToRelativeUrl( AV12UserAvatarSmall))), true);
         AssignProp("", true, imgavUseravatarsmall_Internalname, "SrcSet", context.GetImageSrcSet( AV12UserAvatarSmall), true);
         AV20Useravatarsmall_GXI = AV21Useravatar_GXI;
         AssignProp("", true, imgavUseravatarsmall_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV12UserAvatarSmall)) ? AV20Useravatarsmall_GXI : context.convertURL( context.PathToRelativeUrl( AV12UserAvatarSmall))), true);
         AssignProp("", true, imgavUseravatarsmall_Internalname, "SrcSet", context.GetImageSrcSet( AV12UserAvatarSmall), true);
         GXt_char4 = "";
         ...
         AV23GXV4 = 1;
         AV22GXV3 = GxRegex.Split(AV13UserCaption," ");
         while ( AV23GXV4 <= AV22GXV3.Count )
         {
            AV7Name = AV22GXV3.GetString(AV23GXV4);
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11UserAvatar)) && String.IsNullOrEmpty(StringUtil.RTrim( AV21Useravatar_GXI)) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20243122134776", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2bt_masterpage.js", "?20243122134776", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/metisMenu-master/dist/metisMenu.min.js", "", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/K2BAccordionMenuRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH_MPAGE","{handler:'Refresh',iparms:[{av:'AV19Pgmname',fld:'vPGMNAME_MPAGE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH_MPAGE",",oparms:[{av:'AV15SearchCriteria',fld:'vSEARCHCRITERIA_MPAGE',pic:''}]}");
         setEventMetadata("DOSEARCH_MPAGE","{handler:'E132O1',iparms:[{av:'AV15SearchCriteria',fld:'vSEARCHCRITERIA_MPAGE',pic:''}]");
         setEventMetadata("DOSEARCH_MPAGE",",oparms:[{av:'AV15SearchCriteria',fld:'vSEARCHCRITERIA_MPAGE',pic:''}]}");
         setEventMetadata("TOGGLEMENU_MPAGE","{handler:'E112O1',iparms:[{av:'divMaintable_Class',ctrl:'MAINTABLE_MPAGE',prop:'Class'}]");
         setEventMetadata("TOGGLEMENU_MPAGE",",oparms:[{av:'divMaintable_Class',ctrl:'MAINTABLE_MPAGE',prop:'Class'}]}");
         setEventMetadata("OPENTABLE_MPAGE","{handler:'E142O1',iparms:[{av:'divMyaccountmenu_Visible',ctrl:'MYACCOUNTMENU_MPAGE',prop:'Visible'}]");
         setEventMetadata("OPENTABLE_MPAGE",",oparms:[{av:'divMyaccountmenu_Visible',ctrl:'MYACCOUNTMENU_MPAGE',prop:'Visible'}]}");
         setEventMetadata("CHANGEPASSWORD_MPAGE","{handler:'E152O1',iparms:[]");
         setEventMetadata("CHANGEPASSWORD_MPAGE",",oparms:[]}");
         setEventMetadata("SIGNOUT_MPAGE","{handler:'E182O2',iparms:[]");
         setEventMetadata("SIGNOUT_MPAGE",",oparms:[]}");
         setEventMetadata("APPLICATIONICON_MPAGE.CLICK_MPAGE","{handler:'E122O1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GX_FocusControl = "";
         AV17GXV1 = new GXBaseCollection<SdtK2BAttributeValue_Item>( context, "Item", "test");
         ...
         AV14SearchableTransactions = new GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem>( context, "SearchableTransactionsItem", "test");
         ...
         AV16SearchCriteriaSession = "";
         AV13UserCaption = "";
         AV22GXV3 = new GxSimpleCollection<string>();
         AV7Name = "";
         GXt_char4 = "";
      ...
      private string AV15SearchCriteria ;
      ...
      private string AV16SearchCriteriaSession ;
      ...
      private string AV20Useravatarsmall_GXI ;
      private string AV21Useravatar_GXI ;
      ...
      private GxSimpleCollection<string> AV22GXV3 ;
      private GXBaseCollection<SdtK2BAttributeValue_Item> AV17GXV1 ;
      ...
      private GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem> AV14SearchableTransactions ;
