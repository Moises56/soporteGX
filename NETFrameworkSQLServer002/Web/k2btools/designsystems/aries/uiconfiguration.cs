   ...
   public class uiconfiguration : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, Language_Internalname, context.GetMessage( "Language", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void E140R2( )
      {
         ...
         AV7K2BT_BaseColorOption.gxTpr_Description = context.GetMessage( "Violet", "");
         ...
         AV7K2BT_BaseColorOption.gxTpr_Description = context.GetMessage( "Violet Flat", "");
         AV8K2BT_BaseColorOptions.Add(AV7K2BT_BaseColorOption, 0);
         AV7K2BT_BaseColorOption = new GeneXus.Programs.k2btools.controltypes.coloroptionpicker.SdtColorOptions_Color(context);
         AV7K2BT_BaseColorOption.gxTpr_Id = "green";
         AV7K2BT_BaseColorOption.gxTpr_Colorcode = "#2A898E";
         AV7K2BT_BaseColorOption.gxTpr_Description = context.GetMessage( "Green", "");
         AV8K2BT_BaseColorOptions.Add(AV7K2BT_BaseColorOption, 0);
         AV7K2BT_BaseColorOption = new GeneXus.Programs.k2btools.controltypes.coloroptionpicker.SdtColorOptions_Color(context);
         AV7K2BT_BaseColorOption.gxTpr_Id = "skyblue";
         AV7K2BT_BaseColorOption.gxTpr_Colorcode = "#5CCEDF";
         AV7K2BT_BaseColorOption.gxTpr_Description = context.GetMessage( "Sky Blue", "");
         AV8K2BT_BaseColorOptions.Add(AV7K2BT_BaseColorOption, 0);
         AV7K2BT_BaseColorOption = new GeneXus.Programs.k2btools.controltypes.coloroptionpicker.SdtColorOptions_Color(context);
         AV7K2BT_BaseColorOption.gxTpr_Id = "red";
         AV7K2BT_BaseColorOption.gxTpr_Colorcode = "#A83453";
         AV7K2BT_BaseColorOption.gxTpr_Description = context.GetMessage( "Red", "");
         AV8K2BT_BaseColorOptions.Add(AV7K2BT_BaseColorOption, 0);
         ...
         AV10K2BT_ExtendedControlValuesItem.gxTpr_Description = context.GetMessage( "K2BT_English", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243122132431", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/uiconfiguration.js", "?20243122132431", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BColorOptionPicker/K2BColorOptionPickerRender.js", "", false, true);
