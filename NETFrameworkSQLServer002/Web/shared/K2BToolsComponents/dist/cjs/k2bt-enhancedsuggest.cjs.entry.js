...
const K2btEnhancedsuggest = class {
  constructor(hostRef) {
    ...
    this.changeEvent = index.createEvent(this, "SuggestValueChanged", 7);
    this.newRecordClickedEvent = index.createEvent(this, "newRecordClicked", 7);
    this.inputValueChangedEvent = index.createEvent(this, "inputValueChanged", 7);
    this.value = [];
  ...
  getAtomicValues() {
    const atomicValues = utils.ControlInfoValue.getAtomicValues_impl(this.getRawValues());
  ...
  getSuggestPopoverContent() {
    ...
    if (filteredValues.length > 0)
      ...
      return index.h("div", { class: "K2BT_LoadingSpinner" });
    else
  ...
  addIconIfNecessary(containsIcons, item) {
    return containsIcons ? (index.h("div", { class: "K2BTEnhancedComboIconContainer" }, index.h("img", { class: "K2BTEnhancedComboIcon", src: item.imageUrl, onError: e => this.onImageError(e) }))) : ('');
  }
  addCheckboxIfNecessary(item) {
    return this.isCollection() ? (index.h("div", { class: "K2BT_EnhancedComboCheckbox" }, index.h("input", { type: "checkbox", checked: this.itemIsSelected(item), tabIndex: -1, disabled: this.selectionIsFull() && !this.itemIsSelected(item) }), index.h("label", { htmlFor: "", "data-gx-sr-only": "" }, "\u00A0"))) : ('');
  }
  getItemClass(item) {
  ...
  getCategoryContent(item, containsDetails, containsIcons, containsTrailingText) {
    return (index.h("div", { class: "K2BTEnhancedComboCategory" }, index.h("span", { class: "K2BTEnhancedComboCategoryName" }, item.description), index.h("div", { class: "K2BTEnchancedComboCategoryContents" }, item.items.map(i => this.getItemContent(i, containsDetails, containsIcons, containsTrailingText)))));
  }
  ...
  render() {
    ...
    this.selectedElement = null;
    return (index.h("div", null, index.h("p", { class: "form-control-static", style: this.enabled ? { display: 'none' } : {} }, index.h("span", { class: this.readonlyclass, "data-gx-readonly": "" }, this.getReadonlyValue(headerValues))), index.h("div", { class: "K2BTEnhancedSuggest", ref: node => (this.container = node), style: !this.enabled ? { display: 'none' } : {} }, index.h("div", { class: "K2BTEnhancedSuggestTags" }, this.getHeaderTagsContent(headerValues)), index.h("input", { type: "text", class: "form-control Attribute_Trn K2BTEnhancedSuggestInput", value: this.searchvalue, onInput: event => {
        event.preventDefault();
      ...
      }, ref: control => (this.searchfield = control) }), index.h("div", { class: this.open ? 'K2BTEnhancedComboContentsOpen' : 'K2BTEnhancedComboContentsClosed' }, index.h("div", { class: "K2BTEnhancedComboItems" }, this.getSuggestPopoverContent()), this.enableadditem ? (index.h("span", { class: "K2BTEnhancedComboNewAction", onClick: () => this.onIncludeNewRecordClick() }, this.additemcaption)) : ('')))));
  }
};
K2btEnhancedsuggest.ERROR_SELECTION_FULL = 'SELECTION_FULL';
K2btEnhancedsuggest.style = k2btEnhancedsuggestCss;

exports.k2bt_enhancedsuggest = K2btEnhancedsuggest;
