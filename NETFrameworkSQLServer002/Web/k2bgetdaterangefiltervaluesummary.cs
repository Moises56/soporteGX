...
namespace GeneXus.Programs {
   public class k2bgetdaterangefiltervaluesummary : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         {
            AV10Result = context.localUtil.DToC( AV8DateFrom, (short)(DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt"))), "/") + " - " + context.localUtil.DToC( AV9DateTo, (short)(DateTimeUtil.MapDateFormat( context.GetLanguageProperty( "date_fmt"))), "/");
         }
         else
         {
