...
namespace GeneXus.Programs {
   public class gamhome : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public gamhome( )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( context.GetMessage( "GAM home", "")) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Id), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "GAM home", "") ;
      }
      ...
      protected void WB2U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWelcome_Internalname, context.GetMessage( "WELCOME TO GENEXUS ACCESS MANAGER", ""), "", "", lblWelcome_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, context.GetMessage( "You were redirected to this panel because you don't have the Home Object configured for the application.", ""), "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, context.GetMessage( "If you want to go to the GAM's Backoffice", ""), "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 30, "px", "col-xs-12 col-sm-7", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock7_Internalname, context.GetMessage( "click here", ""), "", "", lblTextblock7_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'GOBACKEND\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 30, "px", "col-xs-12 col-sm-5", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, context.GetMessage( "If you want to go to the Developer Menu ", ""), "", "", lblTextblock5_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 30, "px", "col-xs-12 col-sm-7", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock8_Internalname, context.GetMessage( "click here", ""), "", "", lblTextblock8_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'GODEVMENU\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 30, "px", "col-xs-12 col-sm-5", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, context.GetMessage( "For more information about this, you can", ""), "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 30, "px", "col-xs-12 col-sm-7", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock6_Internalname, context.GetMessage( "click here", ""), "", "", lblTextblock6_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'GODOC\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock9_Internalname, context.GetMessage( "If you want to configure the Home Object you can write it's name here (you have to specify the qualified name if the object is inside a module):", ""), "", "", lblTextblock9_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_label_element( context, edtavApplicationhomeobject_Internalname, context.GetMessage( "Home Object", ""), "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavApplicationhomeobject_Internalname, StringUtil.RTrim( AV6ApplicationHomeObject), StringUtil.RTrim( context.localUtil.Format( AV6ApplicationHomeObject, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "home object name", ""), edtavApplicationhomeobject_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavApplicationhomeobject_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttConfirm_Internalname, "", context.GetMessage( "Save and Go", ""), bttConfirm_Jsonclick, 5, context.GetMessage( "Save and Go", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRM\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMHome.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2U2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "GAM home", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E132U2( )
      {
         ...
         {
            AV11Url = GxRegex.Replace(AV10HttpRequest.BaseURL,context.GetMessage( "/servlet/", ""),"") + "/static/developermenu.html";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243122134596", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamhome.js", "?20243122134597", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRM'","{handler:'E122U2',iparms:[{av:'AV12Id',fld:'vID',pic:'ZZZ9',hsh:true},{av:'AV6ApplicationHomeObject',fld:'vAPPLICATIONHOMEOBJECT',pic:''}]");
         setEventMetadata("'CONFIRM'",",oparms:[]}");
         setEventMetadata("'GODEVMENU'","{handler:'E132U2',iparms:[{av:'AV9isJavaEnvironment',fld:'vISJAVAENVIRONMENT',pic:'',hsh:true},{av:'AV10HttpRequest.BaseURL',ctrl:'vHTTPREQUEST',prop:'Baseurl'}]");
         setEventMetadata("'GODEVMENU'",",oparms:[]}");
         setEventMetadata("'GOBACKEND'","{handler:'E142U2',iparms:[{av:'AV9isJavaEnvironment',fld:'vISJAVAENVIRONMENT',pic:'',hsh:true}]");
         setEventMetadata("'GOBACKEND'",",oparms:[]}");
         setEventMetadata("'GODOC'","{handler:'E152U2',iparms:[]");
