...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( context.GetMessage( "Insert OTP code to login", "")) ;
      ...
      {
         return context.GetMessage( "Insert OTP code to login", "") ;
      }
      ...
      protected void WB2Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbtitle_Internalname, context.GetMessage( "LOGIN", ""), "", "", lblTbtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, 0, "HLP_GAMExampleOTPAuthentication.htm");
            ...
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, context.GetMessage( "User", ""), "col-xs-12 AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, context.GetMessage( "OTP Code", ""), "col-xs-12 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 19,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV15UserPassword), StringUtil.RTrim( context.localUtil.Format( AV15UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "Code", ""), edtavUserpassword_Jsonclick, 0, "Attribute", "", "", "", "", edtavUserpassword_Visible, edtavUserpassword_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnter_Internalname, "", context.GetMessage( "VALIDATE CODE", ""), bttEnter_Jsonclick, 5, context.GetMessage( "VALIDATE CODE", ""), "", StyleString, ClassString, bttEnter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttLogin_Internalname, "", context.GetMessage( "Back to login", ""), bttLogin_Jsonclick, 5, context.GetMessage( "Back to login", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'LOGIN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2Y2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Insert OTP code to login", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E112Y2( )
      {
         ...
         {
            AV5GAMAuthenticationTypeOTP.load( AV7AuthenticationTypeName);
            if ( StringUtil.StrCmp(AV5GAMAuthenticationTypeOTP.gxTpr_Otp.gxTpr_Generationtype, "totp") != 0 )
            {
               GX_msglist.addItem(context.GetMessage( "User access code was sent", ""));
            }
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV17GXV1 = 1;
         while ( AV17GXV1 <= AV9GAMErrorCollection.Count )
         {
            AV8GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9GAMErrorCollection.Item(AV17GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202431221341892", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?202431221341896", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E122Y2',iparms:[{av:'AV7AuthenticationTypeName',fld:'vAUTHENTICATIONTYPENAME',pic:'',hsh:true},{av:'AV16UseTwoFactorAuthentication',fld:'vUSETWOFACTORAUTHENTICATION',pic:'',hsh:true},{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV14UserName',fld:'vUSERNAME',pic:'',hsh:true},{av:'AV15UserPassword',fld:'vUSERPASSWORD',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV15UserPassword',fld:'vUSERPASSWORD',pic:''}]}");
         setEventMetadata("'LOGIN'","{handler:'E132Y2',iparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("'LOGIN'",",oparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV5GAMAuthenticationTypeOTP = new GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeOTP(context);
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeOTP AV5GAMAuthenticationTypeOTP ;
