...
namespace GeneXus.Programs {
   public class exportwwsoporte : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn, 1, 1).Text = context.GetMessage( "SOPORTE", "");
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV20K2BToolsGenericSearchField)) )
         {
            ...
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+0, 1, 1).Text = context.GetMessage( "K2BT_GenericFilterReportLabel", "");
         ...
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+0, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+0, 1, 1).Text = context.GetMessage( "Name", "");
         ...
         if ( AV22GridColumnVisible_soporteID )
         {
            ...
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "ID", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV23GridColumnVisible_hostName )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "HostName", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV24GridColumnVisible_serie )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "Serie", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV25GridColumnVisible_ipv4 )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "IPV4", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV26GridColumnVisible_mac )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "MAC", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV27GridColumnVisible_modelo )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "Modelo", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV28GridColumnVisible_nombreUsuario )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "NombreUsuario", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
         if ( AV30GridColumnVisible_nombreDepartamento )
         {
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Bold = 1;
            AV8ExcelDocument.get_Cells(AV9CellRow, AV10FirstColumn+AV11ColumnIndex, 1, 1).Text = context.GetMessage( "Departamento", "");
            AV11ColumnIndex = (short)(AV11ColumnIndex+1);
         }
      ...
      protected void S131( )
      {
         ...
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "ID", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "hostName";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "HostName", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "serie";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "Serie", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "ipv4";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "IPV4", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "mac";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "MAC", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "modelo";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "Modelo", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "nombreUsuario";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "NombreUsuario", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
         AV19GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV19GridColumn.gxTpr_Attributename = "nombreDepartamento";
         AV19GridColumn.gxTpr_Columntitle = context.GetMessage( "Departamento", "");
         AV19GridColumn.gxTpr_Showattribute = true;
         AV18GridColumns.Add(AV19GridColumn, 0);
