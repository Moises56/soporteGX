...
namespace GeneXus.Programs {
   public class gamgettextpasswordrequirement : GXProcedure
   {
      public gamgettextpasswordrequirement( )
      {
      ...
      public gamgettextpasswordrequirement( IGxContext context )
      {
      ...
      {
         gamgettextpasswordrequirement objgamgettextpasswordrequirement;
         objgamgettextpasswordrequirement = new gamgettextpasswordrequirement();
         objgamgettextpasswordrequirement.AV15TextHTML = "" ;
         objgamgettextpasswordrequirement.context.SetSubmitInitialConfig(context);
         objgamgettextpasswordrequirement.initialize();
         Submit( executePrivateCatch,objgamgettextpasswordrequirement);
         aP0_TextHTML=this.AV15TextHTML;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((gamgettextpasswordrequirement)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( ! (0==AV13SecurityPolicyId) )
         {
            ...
            if ( AV11GAMSecurityPolicy.success() )
            {
               ...
               {
                  AV14Text = StringUtil.Format( context.GetMessage( "Password must be at least %1 characters long.", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumlengthpassword), 2, 0)), "", "", "", "", "", "", "", "");
               ...
               if ( AV11GAMSecurityPolicy.gxTpr_Minimumuppercasecharacterspassword > 0 )
               {
                  ...
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be an uppercase letter.", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumuppercasecharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  else
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be uppercase letters.", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumuppercasecharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  AV8aText.Add(AV14Text, 0);
               }
               if ( AV11GAMSecurityPolicy.gxTpr_Minimumnumericcharacterspassword > 0 )
               {
                  ...
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be a number.", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumnumericcharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  else
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be numbers.", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumnumericcharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  AV8aText.Add(AV14Text, 0);
               }
               if ( AV11GAMSecurityPolicy.gxTpr_Minimumspecialcharacterspassword > 0 )
               {
                  ...
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be a special character (ej.: ! @ # $ % & *).", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumspecialcharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  else
                  {
                     AV14Text = StringUtil.Format( context.GetMessage( "At least %1 must be special characters (ej.: ! @ # $ % & *).", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11GAMSecurityPolicy.gxTpr_Minimumspecialcharacterspassword), 2, 0)), "", "", "", "", "", "", "", "");
                  }
                  AV8aText.Add(AV14Text, 0);
               }
            }
